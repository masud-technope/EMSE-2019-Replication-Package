...
public class JavaLangTypeToResolvedTypeConverter {
    ...
    public ResolvedType fromType(Type aType) {
        if (aType instanceof Class) {
            ...
            if (// check if we are already working on this type
            typeVariablesInProgress.get(aType) != null)
            ...
            typeVariablesInProgress.put(aType, tvrt);
            ...
            typeVariablesInProgress.remove(aType);
            return tvrt;
