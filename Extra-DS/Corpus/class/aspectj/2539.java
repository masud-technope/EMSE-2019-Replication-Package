    ...
    public ResolvedMember[] getDeclaredFields() {
        if (fields == null) {
            ...
            for (int i = 0; i < reflectFields.length; i++) {
                this.fields[i] = ReflectionBasedReferenceTypeDelegateFactory.createResolvedMember(reflectFields[i], world);
            }
        }
        return fields;
    }
    ...
    public ResolvedType[] getDeclaredInterfaces() {
        if (interfaces == null) {
            ...
            for (int i = 0; i < reflectInterfaces.length; i++) {
                this.interfaces[i] = ReflectionBasedReferenceTypeDelegateFactory.resolveTypeInWorld(reflectInterfaces[i], world);
            }
        }
        return interfaces;
    }
    ...
    public ResolvedMember[] getDeclaredMethods() {
        if (methods == null) {
            ...
            for (int i = 0; i < reflectMethods.length; i++) {
                this.methods[i] = ReflectionBasedReferenceTypeDelegateFactory.createResolvedMember(reflectMethods[i], world);
            }
            for (int i = 0; i < reflectCons.length; i++) {
                this.methods[i + reflectMethods.length] = ReflectionBasedReferenceTypeDelegateFactory.createResolvedMember(reflectCons[i], world);
            }
        }
        return methods;
    }
