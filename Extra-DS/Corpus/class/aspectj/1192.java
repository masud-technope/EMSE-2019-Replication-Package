...
public class Params {
    ...
    public static String getString(ExpressionContext context, String varName) {
        try {
    ...
    public static int getInt(ExpressionContext context, String varName) {
    ...
    public static boolean getBoolean(ExpressionContext context, String varName) {
        String stringValue = getString(context, varName);
        if (stringValue != null) {
