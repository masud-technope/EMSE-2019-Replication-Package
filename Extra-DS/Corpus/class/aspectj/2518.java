...
public class TypePatternList extends PatternNode {
    ...
    public static final TypePatternList ANY = //can't use TypePattern.ELLIPSIS because of circular static dependency that introduces
    new TypePatternList(new TypePattern[] { new EllipsisTypePattern() });
    ...
    private static FuzzyBoolean outOfStar(final TypePattern[] pattern, final ResolvedType[] target, int pi, int ti, int pLeft, int tLeft, final int starsLeft, TypePattern.MatchKind kind) {
        if (pLeft > tLeft)
            return FuzzyBoolean.NO;
        FuzzyBoolean finalReturn = FuzzyBoolean.YES;
        while (true) {
    ...
    private static FuzzyBoolean inStar(final TypePattern[] pattern, final ResolvedType[] target, int pi, int ti, final int pLeft, int tLeft, int starsLeft, TypePattern.MatchKind kind) {
