...
public class StyledText extends Canvas {
    ...
    static final boolean IS_CARBON, IS_GTK, IS_MOTIF;
	 ...
	 */
        void initializeRenderer() {
            ...
            renderer = new PrintRenderer(printer, printerFont, gc, printerContent, lineBackgrounds, lineStyles, bidiSegments, parent.tabLength, clientArea);
 ...
 */
    void redrawMultiLineChange(int y, int newLineCount, int replacedLineCount) {
        ...
        scroll(// destination x, y
        0, // destination x, y
        destinationY, // source x, y
        0, // source x, y
 ...
 */
    void scrollHorizontal(int pixels) {
        ...
        if (pixels > 0) {
            ...
            scroll(// destination x, y
            leftMargin, // destination x, y
            topMargin, // source x, y
            sourceX, // source x, y
            ...
            int scrollHeight = clientArea.height - topMargin - bottomMargin;
            scroll(// destination x, y
            destinationX, // destination x, y
            topMargin, // source x, y
            leftMargin, // source x, y
            topMargin, scrollWidth, scrollHeight, true);
    ...
    void setHorizontalScrollBar() {
        ...
        if (horizontalBar != null && horizontalBar.getVisible()) {
            ...
            if (clientArea.width < lineCache.getWidth()) {
                horizontalBar.setValues(horizontalBar.getSelection(), horizontalBar.getMinimum(), // maximum
                lineCache.getWidth(), // thumb size
                clientArea.width - leftMargin - rightMargin, horizontalBar.getIncrement(), // page size
    ...
    void setScrollBars() {
        ...
        if (verticalBar != null) {
            ...
            if (clientArea.height < maximum) {
                verticalBar.setValues(verticalBar.getSelection(), verticalBar.getMinimum(), maximum, // thumb size
                clientArea.height, verticalBar.getIncrement(), // page size
                clientArea.height);
