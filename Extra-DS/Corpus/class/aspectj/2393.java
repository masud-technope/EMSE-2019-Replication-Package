...
public class AroundWeaveTestCase extends WeaveTestCase {
    ...
    private BcelAdvice makeAroundMunger(final boolean matchOnlyPrintln) {
        ...
        final Member sig = MemberImpl.method(UnresolvedType.forName("Aspect"), Modifier.STATIC, "ajc_around", "(Lorg/aspectj/runtime/internal/AroundClosure;)Ljava/lang/Object;");
        return new BcelAdvice(AdviceKind.stringToKind("around"), matchOnlyPrintln ? makePointcutPrintln() : makePointcutAll(), sig, 0, -1, -1, null, UnresolvedType.forName("Aspect").resolve(world)) {
    ...
    private void aroundTestAndOthers(String outName, final boolean matchOnlyPrintln) throws IOException {
