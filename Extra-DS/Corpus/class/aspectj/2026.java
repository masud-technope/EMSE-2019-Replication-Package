...
public abstract class AdviceDeclaration extends BodyDeclaration {
	 ...
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor PARAMETERS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AdviceDeclaration.class, "parameters", SingleVariableDeclaration.class, CYCLE_RISK);

    public static final ChildPropertyDescriptor POINTCUT_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AdviceDeclaration.class, "pointcut", PointcutDesignator.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "thrownExceptions" structural property of this node type).
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor THROWN_EXCEPTIONS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AdviceDeclaration.class, "thrownExceptions", Name.class, NO_CYCLE_RISK);

    /**
	 * The "body" structural property of this node type.
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor BODY_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AdviceDeclaration.class, "body", Block.class, OPTIONAL, CYCLE_RISK);
	 ...
	 */
    protected ASTNode.NodeList parameters = new ASTNode.NodeList(PARAMETERS_PROPERTY);
	 ...
	 * Defaults to an empty list.
	 */
    protected ASTNode.NodeList thrownExceptions = new ASTNode.NodeList(THROWN_EXCEPTIONS_PROPERTY);
