...
class ArrayAnnotationVisitor implements AnnotationVisitor {
    ...
    public void visit(String name, Object value) {
        ...
        if (value instanceof Integer)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_INT, value);
        if (value instanceof Boolean)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_BOOLEAN, value);
        if (value instanceof String)
            val = new SimpleAnnotationValue(AnnotationValue.STRING, value);
        if (value instanceof Long)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_LONG, value);
        if (value instanceof Short)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_SHORT, value);
        if (value instanceof Double)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_DOUBLE, value);
        if (value instanceof Float)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_FLOAT, value);
        if (value instanceof Character)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_CHAR, value);
        if (value instanceof Byte)
            val = new SimpleAnnotationValue(AnnotationValue.PRIMITIVE_BYTE, value);
    ...
    public void visitEnum(String name, String type, String value) {
        ...
        //new AnnotationNameValuePair(name,val));
        arrayValues.add(val);
    }
