...
public class AjdocOutputChecker {
	 ...
	 * @throws Exception
	 */
    public static boolean containsString(File htmlFile, String requiredString) throws Exception {
	 ...
	 * @throws Exception
	 */
    public static List getMissingStringsInFile(/*String*/
    File htmlFile, String[] requiredStrings) throws Exception {
	 ...
	 * @throws Exception
	 */
    public static boolean containsStringWithinSection(File htmlFile, String requiredString, String sectionHeader) throws Exception {
        if ((htmlFile == null) || !htmlFile.getAbsolutePath().endsWith("html")) {
            return false;
        }
        BufferedReader reader = new BufferedReader(new FileReader(htmlFile));
	 ...
	 * @throws Exception
	 */
    public static List getMissingStringsInSection(/*String*/
    File htmlFile, String[] requiredStrings, String sectionHeader) throws Exception {
        List missingStrings = new ArrayList();
        for (int i = 0; i < requiredStrings.length; i++) {
            String string = requiredStrings[i];
	 ...
	 * false otherwise
	 */
    public static boolean classDataSectionContainsRel(File htmlFile, HtmlDecorator.HtmlRelationshipKind relationship, String target) throws Exception {
        if (((htmlFile == null) || !htmlFile.getAbsolutePath().endsWith("html"))) {
            return false;
        }
        BufferedReader reader = new BufferedReader(new FileReader(htmlFile));
        ...
        while (line != null) {
            if (line.indexOf("START OF CLASS DATA") != -1) {
                ...
                while (subLine != null && (subLine.indexOf("========") == -1)) {
	 ...
	 * false otherwise
	 */
    public static boolean detailSectionContainsRel(File htmlFile, String sectionHeader, String source, HtmlDecorator.HtmlRelationshipKind relationship, String target) throws Exception {
        if (((htmlFile == null) || !htmlFile.getAbsolutePath().endsWith("html"))) {
            return false;
        }
            ...
            if (line.indexOf(sectionHeader) != -1) {
                ...
                while (nextLine != null && (nextLine.indexOf("========") == -1)) {
                    if (nextLine.indexOf("NAME=\"" + source + "\"") != -1) {
                        ...
                        String subLine = reader.readLine();
                        while (subLine != null && (subLine.indexOf("========") == -1) && (subLine.indexOf("NAME") == -1)) {
                            int relIndex = subLine.indexOf(relationship.toString());
                            int targetIndex = subLine.indexOf(target);
                            if ((relIndex != -1) && (targetIndex != -1)) {
                                reader.close();
	 ...
	 * false otherwise
	 */
    public static boolean summarySectionContainsRel(File htmlFile, String sectionHeader, String source, HtmlDecorator.HtmlRelationshipKind relationship, String target) throws Exception {
        if (((htmlFile == null) || !htmlFile.getAbsolutePath().endsWith("html"))) {
            return false;
        }
            ...
            if (line.indexOf(sectionHeader) != -1) {
                ...
                while (nextLine != null && (nextLine.indexOf("========") == -1)) {
                    if (nextLine.indexOf(source) != -1) {
                        ...
                        while (subLine != null && (subLine.indexOf("========") == -1) && (subLine.indexOf("<TR BGCOLOR=\"white\" CLASS=\"TableRowColor\">") == -1)) {
                            int relIndex = subLine.indexOf(relationship.toString());
                            int targetIndex = subLine.indexOf(target);
                            if ((relIndex != -1) && (targetIndex != -1)) {
                                reader.close();
