...
public class BuildModuleTest extends TestCase {
    ...
    { "aspectjtools", "ajdoc", "aspectj5rt", "run-all-junit-tests", "ajbrowser", "testing", "testing-drivers", "org.aspectj.ajdt.core", "weaver" };

    private static final String SKIP_MESSAGE = "BuildModuleTest: Define \"run.build.tests\" as a system " + "property to run tests to build ";
    ...
    static {
        ...
        try {
            ...
            useEclipse = ((null != config) && (-1 != config.indexOf("useEclipseCompiles")));
        } catch (Throwable t) {
        }
    ...
    public void testBuild() {
        checkBuild("build", Checklics.class.getName(), // help message
        new String[0], // ant needed
        true);
    }
    ...
    public void testAjbrowser() {
        checkBuild("ajbrowser", "org.aspectj.tools.ajbrowser.Main", // compiler version
    ...
    public void testAjdt() {
        checkBuild("org.aspectj.ajdt.core", "org.aspectj.tools.ajc.Main", new String[] { "-noExit", "-version" });
    }

    //
    public void testTesting() {
        checkBuild("testing", "org.aspectj.testing.util.LangUtilTest", new String[] { "ignored" });
    }

    public void testTestingDrivers() {
        checkBuild("testing-drivers", "org.aspectj.testing.drivers.Harness", new String[] { "-help" });
    }
