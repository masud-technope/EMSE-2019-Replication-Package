...
public class AroundAdviceDeclaration extends AdviceDeclaration {
    ...
    public static final ChildPropertyDescriptor aroundRETURN_TYPE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AroundAdviceDeclaration.class, "returnType", Type.class, MANDATORY, NO_CYCLE_RISK);

    public static final ChildPropertyDescriptor aroundRETURN_TYPE2_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AroundAdviceDeclaration.class, "returnType2", Type.class, OPTIONAL, NO_CYCLE_RISK);

    public static final ChildListPropertyDescriptor aroundTYPE_PARAMETERS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AroundAdviceDeclaration.class, "typeParameters", TypeParameter.class, NO_CYCLE_RISK);
    ...
    public static final ChildListPropertyDescriptor aroundPARAMETERS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AroundAdviceDeclaration.class, "parameters", SingleVariableDeclaration.class, CYCLE_RISK);

    public static final ChildPropertyDescriptor aroundPOINTCUT_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AroundAdviceDeclaration.class, "pointcut", PointcutDesignator.class, MANDATORY, NO_CYCLE_RISK);

    public static final ChildListPropertyDescriptor aroundTHROWN_EXCEPTIONS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AroundAdviceDeclaration.class, "thrownExceptions", Name.class, NO_CYCLE_RISK);

    public static final ChildPropertyDescriptor aroundBODY_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AroundAdviceDeclaration.class, "body", Block.class, OPTIONAL, CYCLE_RISK);
    ...
    private ASTNode.NodeList typeParameters = null;
     ...
     AroundAdviceDeclaration(AST ast) {
        super(ast);
        if (// ajh02: move to aroundAdvice
        ast.apiLevel >= AST.JLS3) {
