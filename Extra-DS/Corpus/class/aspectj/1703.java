...
public class AjCompilerOptions extends CompilerOptions {
    ...
    private void setAspectJWarningDefaults() {
        super.warningThreshold = super.warningThreshold | InvalidAbsoluteTypeName | UnresolvableMember | TypeNotExposedToWeaver | UnmatchedSuperTypeInCall | CannotImplementLazyTJP | CompilerOptions.SwallowedExceptionInCatchBlock;
    }
    ...
    public String toString() {
        ...
        //$NON-NLS-1$
        buf.append("\n\t- swallowed exception in catch block (XLint): ").append(getSeverityString(CompilerOptions.SwallowedExceptionInCatchBlock));
        return buf.toString();
    }
}
