...
public class Java14Tests extends org.aspectj.testing.XMLBasedAjcTestCase {
    ...
    public void test006() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 006 not >=1.4");
            return;
        }
    ...
    public void test007() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 007 not >=1.4");
            return;
        }
        runTest("asserts");
    }
    ...
    public void test008() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 008 not >=1.4");
            return;
        }
    ...
    public void test012() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 012 not >=1.4");
            return;
        }
    ...
    public void test014() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 014 not >=1.4");
            return;
        }
    ...
    public void test015() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 015 not >=1.4");
            return;
        }
    ...
    public void test016() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 016 not >=1.4");
            return;
        }
    ...
    public void test017() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 017 not >=1.4");
            return;
        }
    ...
    public void test021() {
        if (!LangUtil.is14VMOrGreater()) {
            System.err.println("Skipping test 021 not >=1.4");
            return;
        }
