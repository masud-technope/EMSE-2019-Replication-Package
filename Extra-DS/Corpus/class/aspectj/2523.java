 ...
 *
 * <p>$Id: CVS.java,v 1.1 2002/05/15 17:22:28 isberg Exp $</p>
 *
 ...
 *
 * @version $Id: CVS.java,v 1.1 2002/05/15 17:22:28 isberg Exp $
 *
 */
public class CVS {
   ...
   */
    public String localTime(String cvsDate) {
        // A cvsDate has the following form "$Date: 2002/05/15 17:22:28 $"
        ...
        try {
            gmtCal.set(Integer.parseInt(yrS), Integer.parseInt(moS) - 1, Integer.parseInt(daS), Integer.parseInt(hrS), Integer.parseInt(miS), Integer.parseInt(seS));
