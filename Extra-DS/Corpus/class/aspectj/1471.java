...
public class RunValidator implements IRunValidator {
    ...
    public static final IRunValidator PASS = new RunValidator(new ObjectChecker() {
    ...
    public static final IRunValidator FAIL = new RunValidator(new ObjectChecker() {
     ...
     */
    protected  RunValidator(ObjectChecker resultChecker, Class permittedExceptionsClass, Class requiredExceptionsClass) {
    ...
    protected void init(ObjectChecker resultChecker, Class permittedExceptionsClass, Class requiredExceptionsClass) {
        ...
        if ((null != permittedExceptionsClass) && (null != requiredExceptionsClass)) {
