...
public class ClassSubWriter extends AbstractSubWriter {
    ...
    public static class Del extends com.sun.tools.doclets.standard.ClassSubWriter {
        ...
        public void setDelegator(ClassSubWriter mw) {
            this.mw = mw;
        }
    }
    ...
    public  ClassSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc classdoc) {
        super(writer, classdoc);
    }

    public  ClassSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }
    ...
    protected void printModifierAndType(ProgramElementDoc member, Type type) {
        ...
        if (type == null) {
            print(member instanceof AspectDoc ? "aspect" : member.isClass() ? "class" : "interface");
        } else {
            printTypeLink(type);
        }
