...
public class SuperIntroductionSubWriter extends AbstractSubWriter {
    ...
    public  SuperIntroductionSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, AspectDoc ad) {
        super(writer, ad);
    }

    public  SuperIntroductionSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }

    protected final String keyName() {
        return "Super_Introduction";
    }
    ...
    public void printCrosscuts(ClassDoc cd, ProgramElementDoc member) {
        org.aspectj.ajdoc.IntroducedSuperDoc intro = (org.aspectj.ajdoc.IntroducedSuperDoc) member;
        ClassDoc[] targets = intro.targets();
        if (targets.length > 0) {
            writer.dt();
