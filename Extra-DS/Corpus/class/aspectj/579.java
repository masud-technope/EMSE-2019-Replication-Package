public class AutoboxingI {
    ...
    public static void method_takes_Integer(Integer i) {
        System.err.println("method_takes_Integer=" + i);
    }

    public static void method_takes_int(int i) {
        System.err.println("method_takes_int=" + i);
    }
