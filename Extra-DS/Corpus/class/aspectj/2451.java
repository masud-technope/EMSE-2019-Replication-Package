...
class OptionList {
    ...
    public static HashMap getSelectedValues(String optionListValueString) {
        ...
        if (optionListValueString != null) {
            ...
            while (lex.hasMoreTokens()) map.put(lex.nextToken(), lex.nextToken());
        }
        return map;
    }
	 ...
	 * 
	 */
    public static String createListHtmlFromApi(Object[] api, String[] valueNames, String[] optionNames, MessageFormat optionFormat, int selectedIndex) {
