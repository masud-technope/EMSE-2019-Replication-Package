...
public class DeclareParents extends Declare {
    ...
    public Declare parameterizeWith(Map typeVariableBindingMap) {
        DeclareParents ret = new DeclareParents(child.parameterizeWith(typeVariableBindingMap), parents.parameterizeWith(typeVariableBindingMap), isExtends);
    ...
    public List findMatchingNewParents(/*<ResolvedType>*/
    ResolvedType onType, boolean reportErrors) {
        if (onType.isRawType())
