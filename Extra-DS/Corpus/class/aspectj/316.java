    ...
    public String[] getMessages() {
        ...
        while (p3as.hasNext()) {
            ...
            for (int i = 0; i < p3am.length; i++) {
                messages.add("Pass 3a, method " + meth + " ('" + org.aspectj.apache.bcel.Repository.lookupClass(classname).getMethods()[meth] + "'): " + p3am[i]);
            }
        }
        ...
        while (p3bs.hasNext()) {
            ...
            for (int i = 0; i < p3bm.length; i++) {
                messages.add("Pass 3b, method " + meth + " ('" + org.aspectj.apache.bcel.Repository.lookupClass(classname).getMethods()[meth] + "'): " + p3bm[i]);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        for (int k = 0; k < args.length; k++) {
            ...
            if (vr == VerificationResult.VR_OK) {
                JavaClass jc = org.aspectj.apache.bcel.Repository.lookupClass(args[k]);
