...
public class Test4b extends CoreTest {
    ...
    public void testNotWholeCanvas() {
        assertTrue("bounds for this group should not be the whole canvas", g.getBounds().getWidth() < FigureElement.MAX_BOUNDS.getWidth());
        assertTrue("bounds for this group should not be the whole canvas", g.getBounds().getHeight() < FigureElement.MAX_BOUNDS.getHeight());
    }
}
