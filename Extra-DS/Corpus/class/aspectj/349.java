...
public class LTWWorld extends BcelWorld implements IReflectionWorld {
    ...
    protected static final Class concurrentMapClass = makeConcurrentMapClass();

    protected static Map /*<String, WeakReference<ReflectionBasedReferenceTypeDelegate>>*/
    ...
    protected ReferenceTypeDelegate resolveIfBootstrapDelegate(ReferenceType ty) {
        ...
        if (fc == 'j' || fc == 'c' || fc == 'o' || fc == 's') {
            ...
            if (name.startsWith("java") || name.startsWith("com.sun.") || name.startsWith("org.w3c") || name.startsWith("sun.") || name.startsWith("org.omg")) {
