...
public class AjcTaskTester extends AntTaskTester {
    ...
    public void test1_fork() {
        wantClasses("One");
    }

    public void test2_fork() {
        wantClasses("One,Two");
    }

    public void test3_fork() {
        wantClasses("One,Two,Three");
    }

    public void test4_fork() {
        wantClasses("One");
    }

    public void test4b_fork() {
        wantClasses("One");
    }

    public void test5_fork() {
        wantClasses("One,Two");
    }

    public void test5b_fork() {
        wantClasses("One,Two");
    }

    public void test6_fork() {
        wantClasses("One,Two,Three");
    }

    public void test6b_fork() {
        wantClasses("One,Two,Three");
    }

    public void test8_fork() {
        wantClasses("One");
    }

    public void test9_fork() {
        wantClasses("One");
    }

    public void test10_fork() {
        wantClasses("One");
    }

    public void test11_fork() {
        wantClasses("One");
    }

    public void test12_fork() {
        wantClasses("");
    }

    public void test13_fork() {
        wantClasses("One");
    }
