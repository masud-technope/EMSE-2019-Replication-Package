            ...
            case SWT.IMAGE_DISABLE:
                {
                    Rectangle r = srcImage.getBounds();
                    this.type = srcImage.type;
                    byte[] rgbBwBitmapInfo = { /* biSize */
                    40, 0, 0, 0, (byte) (r.width & 0xFF), (byte) ((r.width & 0xFF00) >> 8), (byte) ((r.width & 0xFF0000) >> 16), (byte) ((r.width & 0xFF000000) >> 24), (byte) (r.height & 0xFF), /* biHeight */
                    (byte) ((r.height & 0xFF00) >> 8), (byte) ((r.height & 0xFF0000) >> 16), (byte) ((r.height & 0xFF000000) >> 24), /* biPlanes */
                    1, 0, /* biBitCount */
                    1, 0, /* biCompression */
                    0, 0, 0, 0, /* biSizeImage */
                    ...
                    0, 0, 0, 0, (byte) 0xFF, (byte) 0xFF, /* Second color: white */
                    (byte) 0xFF, 0 };
                    /* Get the HDC for the device */
                    int hDC = device.internal_new_GC(null);
                    /* Source DC */
