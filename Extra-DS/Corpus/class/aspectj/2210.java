...
public class Ajc121Tests extends org.aspectj.testing.XMLBasedAjcTestCase {
    ...
    public void test015_invalidXlint() {
        // keywords: "laurie hendren"
    ...
    public void test031_privateITDinitialisersBeingMatched_OxfordTest() {
        ...
        assertTrue("Expected output '" + exp + "' but got " + getLastRunResult().getStdErr(), getLastRunResult().getStdErr().equals(exp));
    }
    ...
    public void test035_innerAspectCallsPrivateMethod_pr71372() {
        ...
        assertTrue("Expected ':before:around' but got " + s, s.equals(":before:around"));
    }
    ...
    public void test043_pr62642_ExceptionInInitializerError() {
        ...
        String s = getLastRunResult().getStdErr();
        assertTrue("Output should contain java.lang.ExceptionInInitializerError but is '" + s + "'", s.indexOf("java.lang.ExceptionInInitializerError") != -1);
    ...
    public void test065() {
        ...
        assertTrue("The actual output does not match the expected output.  Expected 102 lines but got " + lines + " lines.  Actual output =\n" + s, lines == 102);
