...
public class ThisJoinPointVisitor extends ASTVisitor {
    ...
    boolean canTreatAsStatic(String id) {
        return id.equals("toString") || id.equals("toShortString") || id.equals("toLongString") || id.equals("getKind") || id.equals("getSignature") || id.equals("getSourceLocation");
            ...
            if (canTreatAsStatic(new String(call.selector))) {
                if (replaceEffectivelyStaticRefs) {
                    ...
                    if (call.arguments != null) {
                        ...
                        for (int i = 0; i < argumentsLength; i++) call.arguments[i].traverse(this, scope);
                    }
