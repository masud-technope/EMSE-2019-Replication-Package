...
public class AjASTMatcher extends ASTMatcher {
    ...
    public boolean match(PointcutDeclaration node, Object other) {
        ...
        return safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeMatch(node.getDesignator(), o.getDesignator());
    }
    ...
    public boolean match(BeforeAdviceDeclaration node, Object other) {
        ...
        return safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.parameters(), o.parameters()) && safeSubtreeMatch(node.getPointcut(), o.getPointcut()) && safeSubtreeListMatch(node.thrownExceptions(), o.thrownExceptions()) && safeSubtreeMatch(node.getBody(), o.getBody());
    }
    ...
    public boolean match(InterTypeFieldDeclaration node, Object other) {
        ...
        return safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeListMatch(node.fragments(), o.fragments());
    }
    ...
    public boolean match(InterTypeMethodDeclaration node, Object other) {
        ...
        return ((node.isConstructor() == o.isConstructor()) && safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeMatch(node.getName(), o.getName()) && // n.b. compare return type even for constructors
        safeSubtreeListMatch(node.parameters(), o.parameters()) && node.getExtraDimensions() == o.getExtraDimensions() && safeSubtreeListMatch(node.thrownExceptions(), o.thrownExceptions()) && safeSubtreeMatch(node.getBody(), o.getBody()));
    }
