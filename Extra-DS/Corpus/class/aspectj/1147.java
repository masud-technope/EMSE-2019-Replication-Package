...
public final class Pass3aVerifier extends PassVerifier {
    ...
    public VerificationResult do_verify() {
        if (myOwner.doPass2().equals(VerificationResult.VR_OK)) {
            ...
            if (// IF mg HAS NO CODE (static constraint of Pass 2)
    ...
    private void delayedPass2Checks() {
        ...
        if (lnt != null) {
            ...
            lineNumber_loop: for (// may appear in any order.
            int i = 0; // may appear in any order.
            i < lineNumbers.length; // may appear in any order.
            i++) {
    ...
    private void pass3StaticInstructionChecks() {
        if (// contradicts vmspec2 page 152 ("Limitations"), but is on page 134.
        !(code.getCode().length < 65536)) {
        ...
        if (!((last instanceof ReturnInstruction) || (last instanceof RET) || (last instanceof GotoInstruction) || // JSR / JSR_W would possibly RETurn and then fall off the code!
    ...
    private class InstOperandConstraintVisitor extends org.aspectj.apache.bcel.generic.EmptyVisitor {
        ...
        public void visitLoadClass(LoadClass o) {
            ...
            if (// null means "no class is loaded"
            t != null) {
        ...
        public void visitNEWARRAY(NEWARRAY o) {
            ...
            if (!((t == Constants.T_BOOLEAN) || (t == Constants.T_CHAR) || (t == Constants.T_FLOAT) || (t == Constants.T_DOUBLE) || (t == Constants.T_BYTE) || (t == Constants.T_SHORT) || (t == Constants.T_INT) || (t == Constants.T_LONG))) {
        ...
        public void visitINVOKESTATIC(INVOKESTATIC o) {
            ...
            if (// implies it's not abstract, verified in pass 2.
            !(m.isStatic())) {
