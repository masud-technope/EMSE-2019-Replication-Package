...
public class MainTest extends AjcTestCase {
    ...
    public void testDashX() {
        ...
        xoptionText = "non-standard options:";
        CompilationResult result = ajc(null, new String[] { "-X" });
        assertMessages(result, "Expecting xoptions usage message", new MessageSpec(null, null, null, newMessageList(new Message(xoptionText)), null));
    }
