...
public class InstConstraintVisitor extends EmptyVisitor implements org.aspectj.apache.bcel.generic.Visitor {
   ...
   */
    ...
    public void visitStoreInstruction(StoreInstruction o) {
        if (// Don't bother about 1 or 2 stack slots used. This check is implicitely done below while type checking.
        stack().isEmpty()) {
            constraintViolated(o, "Cannot STORE: Stack to read from is empty.");
        }
        if ((!(o instanceof ASTORE))) {
            if (// the other xSTORE types are singletons in BCEL.
            !(stack().peek() == o.getType(cpg))) {
    ...
    public void visitBALOAD(BALOAD o) {
        ...
        indexOfInt(o, index);
        if (arrayrefOfArrayType(o, arrayref)) {
            if (!((((ArrayType) arrayref).getElementType().equals(Type.BOOLEAN)) || (((ArrayType) arrayref).getElementType().equals(Type.BYTE)))) {
