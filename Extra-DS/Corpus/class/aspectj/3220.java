...
public class PartiallyExposedHierarchyTestCase extends AjcTestCase {
    ...
    public void testPartiallyExposedHierarchy() {
        ...
        CompilationResult result = ajc(baseDir, new String[] { "-classpath", "fullBase.jar", "-injars", "base.jar", "sample" + File.separator + "Trace.aj" });
        ...
        MessageSpec spec = new MessageSpec(null, newMessageList(warning), null);
