   ...
   */
    ...
    */
    ...
    private static BitMatrix sampleGrid(BitMatrix matrix, ResultPoint topLeft, ResultPoint bottomLeft, ResultPoint topRight, ResultPoint bottomRight, int dimension) throws NotFoundException {
        ...
        0.0f, // p4ToY
        dimension, // p1FromX
        topLeft.getX(), // p1FromY
        topLeft.getY(), // p2FromX
        topRight.getX(), // p2FromY
        topRight.getY(), // p3FromX
        bottomRight.getX(), // p3FromY
        bottomRight.getY(), // p4FromX
        bottomLeft.getX(), // p4FromY
        bottomLeft.getY());
    }
