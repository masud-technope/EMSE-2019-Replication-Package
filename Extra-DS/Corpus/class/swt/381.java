...
public class Callback {
    ...
    //$NON-NLS-1$  //$NON-NLS-2$
    static final String PTR_SIGNATURE = PTR_SIZEOF == 4 ? "I" : "J";
 ...
 */
    public  Callback(Object object, String method, int argCount, boolean isArrayBased, int /*long*/
    errorResult) {
 ...
 */
    static native synchronized int bind(Callback callback, Object object, String method, String signature, int argCount, boolean isStatic, boolean isArrayBased, int /*long*/
    errorResult);
