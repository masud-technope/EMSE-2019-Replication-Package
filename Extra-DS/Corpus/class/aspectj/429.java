...
public class GenericTest {
    ...
    public static void main(String[] args) {
        ...
        h.checkAllDecsOf(classDec, new Declaration[] { fieldDecI, fieldDecF, //initDec,
        methodDecV, methodDecVI, methodDecVLF, methodDecISO });
        h.checkAllDecsOf(aspectDec, new Declaration[] { pointcutDecInstOf, pointcutDecHasAsp, pointcutDecWithin, pointcutDecWithinAll, pointcutDecWithinCode, pointcutDecCFlow, pointcutDecCFlowTop, pointcutDecCalls, pointcutDecRec, pointcutDecExec, pointcutDecCallsTo, pointcutDecHandThr, pointcutDecHandErr, pointcutDecHandExc, pointcutDecHandRt, pointcutDecGets, pointcutDecSets, adviceDecBefore, adviceDecAfter, adviceDecAfterRet, adviceDecAfterThr, adviceDecAround, adviceDecBeforeToString, adviceDecBeforeNew, fieldDecIntrD, methodDecIntrV });
        if (!h.allDecsFound)
            return;
