...
public class TypeImpl {
    ...
    public static com.sun.javadoc.Type getInstance(String spec, ClassDoc where) {
        return factory.getInstance(spec, where);
    }

    private static final class Primitive implements org.aspectj.ajdoc.Type {
    ...
    private static final class Array implements org.aspectj.ajdoc.Type {
        ...
        public boolean equals(Object other) {
            ...
            return array.type.equals(type) && array.dimension == dimension;
        }
    }
    ...
    private static final class Factory {
        ...
        private com.sun.javadoc.Type getInstance(Type type) {
            if (type instanceof PrimitiveType) {
                ...
                return new Array(getInstance(component), arrayType.getArrayDimCount());
            } else {
                return ClassDocImpl.getInstance(((NameType) type).getTypeDec());
            }
        }

        private com.sun.javadoc.Type getInstance(String spec, ClassDoc where) {
