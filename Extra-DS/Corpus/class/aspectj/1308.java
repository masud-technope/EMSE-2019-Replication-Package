...
public class AfterThrowingWeaveTestCase extends WeaveTestCase {
    ...
    public void testAfterThrowingParam() throws IOException {
        ...
        ShadowMunger myMunger = world.shadowMunger("afterThrowing(): get(* *.out) -> static void Aspect.ajc_afterThrowing_field_get(java.lang.Throwable)", Advice.ExtraArgument);
