 ...
 *
 * <p>$Id: Text.java,v 1.1 2002/05/15 17:22:28 isberg Exp $</p>
 *
 ...
 *
 * @version $Id: Text.java,v 1.1 2002/05/15 17:22:28 isberg Exp $
 *
 */
public class Text {
   ...
   */
    ...
    public NodeList insertfile(XSLProcessorContext context, ElemExtensionCall elem) throws MalformedURLException, FileNotFoundException, IOException, TransformerException {
    ...
    private String getFilename(XSLProcessorContext context, ElemExtensionCall elem) throws java.net.MalformedURLException, java.io.FileNotFoundException, java.io.IOException, javax.xml.transform.TransformerException {
        String fileName;
        fileName = ((ElemExtensionCall) elem).getAttribute("href", context.getContextNode(), context.getTransformer());
        if (fileName == null) {
            context.getTransformer().getMsgMgr().error(elem, "No 'href' on text, or not a filename");
        }
        return fileName;
    }
}
