...
public class Main {
    ...
    private static final String OUT_OF_MEMORY_MSG = "AspectJ " + Version.text + " ran out of memory during compilation:" + LangUtil.EOL + LangUtil.EOL + "Please increase the memory available to ajc by editing the ajc script " + LangUtil.EOL + "found in your AspectJ installation directory. The -Xmx parameter value" + LangUtil.EOL + "should be increased from 64M (default) to 128M or even 256M." + LangUtil.EOL + LangUtil.EOL + "See the AspectJ FAQ available from the documentation link" + LangUtil.EOL + "on the AspectJ home page at http://www.eclipse.org/aspectj";
    ...
    public static class CommandController {
        ...
        /** @see init(String[]) */
        private static String[][] OPTIONS = new String[][] { new String[] { INCREMENTAL_OPTION }, new String[] { TAG_FILE_OPTION, null } };
        ...
        boolean doRepeatCommand(ICommand command) {
            ...
            if (quit) {
                ...
                } catch (IOException // XXX silence for error?
                e) {
                    result = false;
                }
        ...
        protected void fileCheckDelay() {
            ...
            while (targetTime > System.currentTimeMillis()) {
                ...
                try // 1/3-second delta for quit check
                {
                    Thread.sleep(300);
