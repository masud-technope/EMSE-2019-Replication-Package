...
public class CompareFiles extends org.apache.tools.ant.Task {
    ...
    */
    ...
    public void setLhsFile(File file) {
        lhsFile = file;
    }

    public void setRhsFile(File file) {
        rhsFile = file;
    }
    ...
    public void setFilterSpec(String str) {
        worker.setFilterSpec(str);
    }

    public void setCollapseWhitespace(boolean ok) {
        worker.setCollapseWhitespace(ok);
    }

    public void setTrimWhitespace(boolean ok) {
        worker.setTrimWhitespace(ok);
    }

    public void setIgnoreCase(boolean ok) {
        worker.setIgnoreCase(ok);
    }
    ...
    public void execute() throws BuildException {
        if (!lhsFile.canRead()) {
            ...
            log("FAIL taskdefs.CompareFiles: both must be dirs." + " lhsFile=" + lhsFile + " rhsFile=" + rhsFile);
        } else {
