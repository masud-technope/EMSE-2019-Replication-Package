...
public class WeaverAdapter implements IClassFileProvider, IWeaveRequestor, Iterator {
    ...
    public  WeaverAdapter(AjCompilerAdapter forCompiler, WeaverMessageHandler weaverMessageHandler, IProgressListener progressListener) {
    ...
    public void acceptResult(UnwovenClassFile result) {
        ...
        AjClassFile ajcf = new AjClassFile(className.toCharArray(), result.getBytes());
        ...
        if (progressListener != null) {
            ...
            recordProgress(fromPercent + ((progressCompletionCount / (double) progressMaxTypes) * (toPercent - fromPercent)), progressPhasePrefix + result.getClassName() + " (from " + nowProcessing.fileName() + ")");
