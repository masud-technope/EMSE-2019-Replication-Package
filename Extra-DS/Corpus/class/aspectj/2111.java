...
public class WorkingTestMain {
    ...
    public static void testOne() throws IOException {
        ...
        args.add("out");
        args.add("-classpath");
        args.add(AjcTests.aspectjrtClasspath() + File.pathSeparator + "../testing-client/bin");
    ...
    public static void testExamples() throws IOException {
        example(new String[] { "observer/files.lst" }, // don't run the gui
        new String[] {});
        ...
        example(new String[] { "spacewar/demo.lst" }, // don't run the gui
        new String[] {});
        example(new String[] { "spacewar/debug.lst" }, // don't run the gui
        new String[] {});
