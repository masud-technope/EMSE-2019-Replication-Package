...
public class ConstructorSubWriter extends ExecutableMemberSubWriter {
    ...
    public static class Del extends com.sun.tools.doclets.standard.ConstructorSubWriter {
        ...
        public void setDelegator(ConstructorSubWriter mw) {
            this.mw = mw;
        }
    ...
    public  ConstructorSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc classdoc) {
        super(writer, classdoc);
    }

    public  ConstructorSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }
