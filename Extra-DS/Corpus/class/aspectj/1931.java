 ...
 * @author Jeff Palm
 */
public class PackageDocImpl extends DocImpl implements org.aspectj.ajdoc.PackageDoc {
    ...
    public ClassDoc findClass(String className) {
        Type type = ajc.getTypeManager().findType(name(), className);
        if (type != null) {
    ...
    public AspectDoc[] aspects() {
        ...
        return (AspectDoc[]) list.toArray(new AspectDoc[list.size()]);
    }
    ...
    public boolean equals(Object other) {
        return other instanceof PackageDocImpl && other != null ? name().equals(((PackageDocImpl) other).name()) : super.equals(other);
    }
    ...
    private void findDocumentation() {
        if (ajdoc == null)
            return;
        String filename = (name.equals("") ? name : name.replace('.', File.separatorChar) + File.separatorChar) + "package.html";
