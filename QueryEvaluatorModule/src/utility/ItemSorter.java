...
public class ItemSorter {
	...
	public static List<Map.Entry<String, Integer>> sortHashMapInt(
			HashMap<String, Integer> wordMap, boolean ascendingOrder) {
		List<Map.Entry<String, Integer>> list = new LinkedList<>(
				wordMap.entrySet());
		list.sort(new Comparator<Map.Entry<String, Integer>>() {
			@Override
	...
	public static List<Map.Entry<String, Double>> sortHashMap(
			HashMap<String, Double> wordMap, boolean ascendingOrder) {
