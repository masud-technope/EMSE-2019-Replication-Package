...
class MethVisitor implements MethodVisitor {
    ...
    public  MethVisitor(AsmMethod rm) {
        am = rm;
    }

    public AnnotationVisitor visitAnnotationDefault() {
        // means we are ignoring default values - is that a problem?
    ...
    public void visitAttribute(Attribute attr) {
        if (am.attributes == Collections.EMPTY_LIST)
            am.attributes = new ArrayList();
