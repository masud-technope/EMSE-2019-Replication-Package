...
public class LangUtilTest extends TestCase {
    ...
    public void testVersion() {
        ...
        assertTrue(LangUtil.is13VMOrGreater());
    ...
    public void testExtractOptionsArrayCollector() {
        String[] args = new String[] { "-d", "classes", "-classpath", "foo.jar", "-verbose", "Bar.java" };
        String[][] OPTIONS = new String[][] { new String[] { "-classpath", null }, new String[] { "-d", null }, new String[] { "-verbose" }, new String[] { "-help" } };
    ...
    public void testOptionVariants() {
        ...
        checkOptionVariants(threeB, new String[][] { NONE, one, two, new String[] { "-1", "-2" }, three, new String[] { "-1", "-3" }, new String[] { "-2", "-3" }, new String[] { "-1", "-2", "-3" } });
        checkOptionVariants(athreeB, new String[][] { new String[] { "a" }, new String[] { "a", "-1" }, new String[] { "a", "-2" }, new String[] { "a", "-1", "-2" }, new String[] { "a", "-3" }, new String[] { "a", "-1", "-3" }, new String[] { "a", "-2", "-3" }, new String[] { "a", "-1", "-2", "-3" } });
        checkOptionVariants(threeaB, new String[][] { new String[] { "a" }, new String[] { "-1", "a" }, new String[] { "a", "-2" }, new String[] { "-1", "a", "-2" }, new String[] { "a", "-3" }, new String[] { "-1", "a", "-3" }, new String[] { "a", "-2", "-3" }, new String[] { "-1", "a", "-2", "-3" } });
    }
    ...
    void checkOptionVariants(String[] options, String[][] expected) {
        ...
        for (int i = 0; i < expected.length; i++) {
            assertEquals("" + i, "" + Arrays.asList(expected[i]), "" + Arrays.asList(result[i]));
        }
    }
