...
public abstract class DocImpl implements org.aspectj.ajdoc.Doc {
    ...
    public int compareTo(Object other) {
        return other instanceof Doc ? Util.compareTo(this, (Doc) other) : -1;
    }
    ...
    public String getRawCommentText() {
        return getComment() != null ? getComment().rawCommentText() : "";
    }
    ...
    public Tag[] tags(String tagname) {
        return getComment() != null ? getComment().tags(tagname) : new Tag[0];
    }
