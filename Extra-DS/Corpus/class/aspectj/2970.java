...
public class QualifiedSuperCall extends PackageSuper {
    ...
    class Inner {
        ...
        void m() {
            ...
            Tester.event("QualifiedSuperCall.super.field = " + QualifiedSuperCall.super.field);
            QualifiedSuperCall.super.m();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Tester.checkEvents(new String[] { "Inner.m()", "PackageSuper.m()", "QualifiedSuperCall.super.field = PackageSuper" });
    }
