        ...
        if (configFile == null) {
            ...
            if (!fresh) {
                ...
                if (!configFile.equals(lastConfigFile)) {
                    ...
                    if (// have to full build
                    correctStateForConfig == null)
                        // have to full build
                        fresh = true;
                    else {
        ...
        public void run() {
            ...
            try {
                ...
                if (Ajde.getDefault().isLogging())
                    Ajde.getDefault().logEvent("building with options: " + getFormattedOptionsString(buildOptions, Ajde.getDefault().getProjectProperties()));
