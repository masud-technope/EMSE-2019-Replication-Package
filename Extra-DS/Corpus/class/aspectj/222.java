...
*/
            ...
            */
            ...
            HtmlDecorator.decorateHTMLFromInputFiles(declIDTable, rootDir, inputFiles, docModifier);
            ...
            if (packageList.size() > 0) {
                for (int p = 0; p < packageList.size(); p++) {
                    removeDeclIDsFromFile(((String) packageList.elementAt(p)).replace('.', '/') + Config.DIR_SEP_CHAR + "package-summary.html", true);
                }
            } else {
    ...
    static void parseArgs(List vargs, File currentWorkingDir) {
        ...
        // used for discrepancy betwen class/sourcepath in ajc/javadoc
                        ...
                        if (pkg.isDirectory()) {
                            String[] files = pkg.list(new FilenameFilter() {
                                ...
                                public boolean accept(File dir, String name) {
                                    ...
                                    if ((index1 >= 0 && index2 >= 0) && (name.substring(index1, index2).equals(".java") || name.substring(index1, index2).equals(".aj"))) {
                                        return true;
                                    } else {
                                        return false;
                                    }
