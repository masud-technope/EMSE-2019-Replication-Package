...
public class SubTypeComparator implements Comparator {
	 ...
	 */
    private // todo: sync on comparators
    Struct[] getComparators() {
    ...
    public final int compare(Object lhs, Object rhs) {
        ...
        if (Integer.MAX_VALUE == result) {
            ...
            for (int i = 0; i < comp.length; i++) {
                ...
                if ((compClass.isAssignableFrom(lhClass)) && (compClass.isAssignableFrom(lhClass))) {
                    return comp[i].comparator.compare(lhs, rhs);
                }
            }
            // not found - throw ClassCastException
            String mssg = "Unable to find Comparator for " + "lhs Class: " + lhClass.getName() + " rhs Class: " + rhClass.getName();
    ...
    static class Struct {
        ...
        public boolean equals(Object o) {
            return ((null != o) && (o instanceof Struct) && (accepts == ((Struct) o).accepts));
        }
    }
    ...
    static class Test {
        ...
        public void runTest(String[] args) {
            ...
            if ((null == result) && (!ClassCastException.class.isAssignableFrom(result.getClass()))) {
            ...
            if ((null == result) && (!Error.class.isAssignableFrom(result.getClass()))) {
