...
public class MethodIntroductionSubWriter extends MethodSubWriter {
    ...
    public  MethodIntroductionSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, AspectDoc ad) {
        super(writer, ad);
    }

    public  MethodIntroductionSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }

    protected final String keyName() {
        return "Method_Introduction";
    }
    ...
    public void printCrosscuts(ClassDoc cd, ProgramElementDoc member) {
        ...
        if (targets.length > 0) {
            ...
            for (int i = 0; i < targets.length; i++) {
                ...
                writer.printClassLink(target, "methods_introduced_from_class_" + cd.qualifiedName(), target.name());
            }
            writer.codeEnd();
