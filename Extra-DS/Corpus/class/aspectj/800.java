...
class Player extends Pilot implements KeyListener {
    ...
    // current rotation key
    private int rotation_direction = Ship.STOP;
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (keyCode == keyMapping.fire) {
            ...
            ship.thrust(true);
            thrust_on = true;
        } else if (keyCode == keyMapping.right && rotation_direction != Ship.COUNTERCLOCKWISE) {
            //start rotating clockwise unless already rotating in the
            //opposite direction
            rotation_direction = Ship.CLOCKWISE;
            ship.rotate(Ship.CLOCKWISE);
        } else if (keyCode == keyMapping.left && rotation_direction != Ship.CLOCKWISE) {
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (keyCode == keyMapping.thrust) {
            ...
            ship.thrust(false);
            thrust_on = false;
        } else if (keyCode == keyMapping.right && rotation_direction == Ship.CLOCKWISE || keyCode == keyMapping.left && rotation_direction == Ship.COUNTERCLOCKWISE) {
            //stop rotation
            ship.rotate(Ship.STOP);
