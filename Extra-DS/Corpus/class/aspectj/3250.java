...
public class JTreeNodeGenericTreeNodeFactory implements GenericTreeNodeFactoryI {
    ...
    public static final GenericTreeNodeFactoryI SINGLETON = new JTreeNodeGenericTreeNodeFactory();
    ...
    static class JTreeNodeComparator implements Comparator {
        ...
        public int compare(Object lhs, Object rhs) {
            ...
            if (Integer.MAX_VALUE == result) {
                ...
                if ((DefaultMutableTreeNode.class.isAssignableFrom(lhClass)) && (DefaultMutableTreeNode.class.isAssignableFrom(rhClass))) {
