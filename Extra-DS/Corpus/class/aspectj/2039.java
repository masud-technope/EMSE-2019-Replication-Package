...
public class StructureUtil {
	 ...
	 */
    public static List getTargets(/*String*/
    IProgramElement node, IRelationship.Kind kind) {
	 ...
	 */
    public static List getTargets(/*String*/
    IProgramElement node, IRelationship.Kind kind, String relName) {
    ...
    static List getDeclareInterTypeTargets(/*IProgramElement */
    IProgramElement node, IProgramElement.Kind kind) {
        List targets = new ArrayList();
    ...
    public static List getDeclareTargets(/*String*/
