...
public abstract class AbstractRunSpec implements IRunSpec {
    ...
    // nonfinal only for clone()
    protected String xmlElementName;

    protected final ArrayList /*String*/
    keywords;

    protected final IMessageHolder /*IMessage*/
    messages;
    ...
    protected final ArrayList /*IRunSpec*/
    children;

    protected final ArrayList /*DirChanges.Spec*/
    dirChanges;
    ...
    public boolean adoptParentValues(RT parentRuntime, IMessageHandler handler) {
        ...
        if (null != parentRuntime) {
            ...
            if (skipped && skipIfAnyChildSkipped) {
    ...
    protected boolean haveAttributes() {
        return ((!LangUtil.isEmpty(xmlNames.descriptionName) && !LangUtil.isEmpty(description)) || (!LangUtil.isEmpty(xmlNames.keywordsName) && !LangUtil.isEmpty(keywords)) || (!LangUtil.isEmpty(xmlNames.optionsName) && !LangUtil.isEmpty(options)) || (!LangUtil.isEmpty(xmlNames.pathsName) && !LangUtil.isEmpty(paths)));
    }
    ...
    public void printAll(PrintStream out, String prefix) {
        ...
        for (Iterator iter = children.iterator(); iter.hasNext(); ) {
            // IRunSpec
            AbstractRunSpec child = (AbstractRunSpec) iter.next();
    ...
    public static class XMLNames {
        ...
        public static final XMLNames DEFAULT = new XMLNames(null, "description", "sourceLocation", "keywords", "options", "paths", "comment", "staging", "badInput", false, false, false);
        ...
        protected Object clone() {
            return new XMLNames(null, descriptionName, sourceLocationName, keywordsName, optionsName, pathsName, commentName, stagingName, badInputName, skipDirChanges, skipMessages, skipChildren);
        }

        /** reset all names/behavior or pass defaultNames 
         * as the defaults for any null elements 
         */
         XMLNames(XMLNames defaultNames, String descriptionName, String sourceLocationName, String keywordsName, String optionsName, String pathsName, String commentName, String stagingName, String badInputName, boolean skipDirChanges, boolean skipMessages, boolean skipChildren) {
