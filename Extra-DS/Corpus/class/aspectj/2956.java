...
public class AjcHarnessTestsUsingJUnit extends TestCase {
    ...
    public static TestSuite suite() {
        ...
        result.addTest(HarnessJUnitUtil.suite("harness", new String[] { "../tests/ajcHarnessTests.xml" }, null));
        result.addTest(HarnessJUnitUtil.suite("harness selection tests", new String[] { "testdata/incremental/harness/selectionTest.xml" }, null));
        return result;
    }
