...
public class Box extends ShapeFigureElement {
    ...
    public void checkBoxness() {
        if ((_p0.getX() == _p3.getX()) && (_p1.getX() == _p2.getX()) && (_p0.getY() == _p1.getY()) && (_p2.getY() == _p3.getY()))
            return;
    ...
    public Shape getShape() {
        return new Rectangle(getP1().getX(), getP1().getY(), getP3().getX() - getP1().getX(), getP3().getY() - getP1().getY());
    }
}
