...
public class JoinPointSignatureIterator implements Iterator {
    ...
    private List /*JoinPointSignature*/
    discoveredSignatures = new ArrayList();
    ...
    //new ArrayList();
    private List /*SearchPair*/
    yetToBeProcessedSuperMembers = null;
            ...
            if (visitedSuperTypes.contains(superType)) {
                ...
                if (foundMember != null && isVisibleTo(firstDefiningMember, foundMember)) {
                    ...
                    for (Iterator iter = declaringTypes.iterator(); iter.hasNext(); ) {
                        ...
                        // for this time
                        additionalSignatures.add(// for this time
                        member);
                    }
