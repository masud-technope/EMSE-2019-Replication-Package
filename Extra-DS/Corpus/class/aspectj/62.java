...
public class DeclarePrecedenceDeclaration extends DeclareDeclaration {
    ...
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = internalJavadocPropertyFactory(DeclarePrecedenceDeclaration.class);

    public static final ChildListPropertyDescriptor TYPE_PATTERNS_LIST_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(DeclarePrecedenceDeclaration.class, "parentTypePatterns", TypePattern.class, NO_CYCLE_RISK);
    ...
    ASTNode clone0(AST target) {
        ...
        result.typePatterns().addAll(ASTNode.copySubtrees(target, typePatterns()));
        return result;
    }
    ...
    int treeSize() {
        return memSize() + (this.optionalDocComment == null ? 0 : getJavadoc().treeSize()) + (this.modifiers == null ? 0 : this.modifiers.listSize()) + this.typePatterns.listSize();
    }
}
