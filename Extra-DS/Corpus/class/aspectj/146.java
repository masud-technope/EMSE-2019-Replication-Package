...
public class AjTypeConstants {
    ...
    public static final char[][] ORG_ASPECTJ_LANG_JOINPOINT = new char[][] { ORG, ASPECTJ, LANG, "JoinPoint".toCharArray() };

    public static final char[][] ORG_ASPECTJ_LANG_JOINPOINT_STATICPART = new char[][] { ORG, ASPECTJ, LANG, "JoinPoint".toCharArray(), "StaticPart".toCharArray() };

    public static final char[][] ORG_ASPECTJ_RUNTIME_INTERNAL_AROUNDCLOSURE = new char[][] { ORG, ASPECTJ, RUNTIME, INTERNAL, "AroundClosure".toCharArray() };

    public static final char[][] ORG_ASPECTJ_RUNTIME_INTERNAL_CONVERSIONS = new char[][] { ORG, ASPECTJ, RUNTIME, INTERNAL, "Conversions".toCharArray() };
