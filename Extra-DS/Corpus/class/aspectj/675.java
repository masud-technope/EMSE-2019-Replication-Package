...
public class DeclareWarningDeclaration extends DeclareDeclaration {
    ...
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = internalJavadocPropertyFactory(DeclareWarningDeclaration.class);

    public static final ChildPropertyDescriptor POINTCUT_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(DeclareWarningDeclaration.class, "pointcut", PointcutDesignator.class, MANDATORY, NO_CYCLE_RISK);

    public static final ChildPropertyDescriptor MESSAGE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(DeclareWarningDeclaration.class, "message", StringLiteral.class, MANDATORY, NO_CYCLE_RISK);
