...
public class Tester {
    ...
    public static void checkEqual(Object[] value, Object[] expectedValue, String message) {
        ...
        if (n != expectedValue.length) {
            checkFailed(message + " expected array of length " + n + " got " + expectedValue.length);
            return;
        }
        for (int i = 0; i < n; i++) {
            if (!value[i].equals(expectedValue[i])) {
                checkFailed(message + ": " + value[i] + " != " + expectedValue[i] + " at index " + i);
            }
        }
    }
    ...
    public static void checkNonNull(Object o, String name) {
        if (o == null)
            checkFailed(name + " shouldn't be null");
    }
    ...
    public static void checkEventsFromFile(String eventsFile) {
        ...
        try {
            // XXX TestDriver
            File file = new File(getBASEDIR(), eventsFile);
     ...
     */
    public static void checkEqualLists(List /*String*/
    actual, List expected, String message) {
