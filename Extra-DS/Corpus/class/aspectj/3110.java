...
public class WildTypePatternResolutionTestCase extends TestCase {
    ...
    public void testSomethingExtends() {
        ...
        ResolvedType listOfNumber = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[] { UnresolvedType.forName("java.lang.Number").resolve(world) }, world);
        ResolvedType listOfDouble = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[] { UnresolvedType.forName("java.lang.Double").resolve(world) }, world);
        ...
        ResolvedType listOfExtendsNumber = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[] { extendsNumber }, world);
    ...
    public void testSomethingExtendsPattern() {
        ...
        ResolvedType listOfExtendsDouble = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[] { extendsDouble }, world);
    ...
    public void testSomethingSuper() {
        ...
        ResolvedType listOfSuperDouble = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[] { superDouble }, world);
    ...
    protected void setUp() throws Exception {
        ...
        this.javaUtilListOfDouble = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[] { UnresolvedType.forName("java.lang.Double").resolve(world) }, world);
        this.javaUtilListOfSomething = TypeFactory.createParameterizedType(javaUtilList, new UnresolvedType[] { UnresolvedType.SOMETHING.resolve(world) }, world);
    }
}
