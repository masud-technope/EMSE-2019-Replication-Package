...
class StructureViewTreeListener implements TreeSelectionListener, MouseListener {
    ...
    public void navigate(MouseEvent e) {
        ...
        if (treeNode == null || lastSelectedNode == treeNode)
            return;
        lastSelectedNode = treeNode;
        //if (e.getClickCount() == 2) {
        Ajde.getDefault().getStructureViewManager().fireNavigationAction(treeNode.getStructureNode(), treeNode.getKind() == IStructureViewNode.Kind.LINK);
    //}
    }
}
