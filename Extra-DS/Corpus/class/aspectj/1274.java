...
public class AjctestsAdapter extends TestSuite {
    ...
    public static final String VERBOSE_NAME = AjctestsAdapter.class.getName() + ".VERBOSE";

    private static final boolean VERBOSE = HarnessJUnitUtil.readBooleanSystemProperty(VERBOSE_NAME);
    ...
    public void addTest(Test test) {
        if (!(test instanceof AjcTestSpecAsTest)) {
            String m = "expecting AjcTestSpecAsTest, got " + (null == test ? "null test" : test.getClass().getName() + ": " + test);
    ...
    protected void runTest(AjcTestSpecAsTest test, TestResult result) {
        ...
        try {
            ...
            try {
                ...
                HarnessJUnitUtil.reportResult(null, status, test, numIncomplete);
            } finally {
    ...
    public static class SpecTests {
        ...
        protected void runTest(String description) {
            ...
            AjctestsAdapter.AjcTestSpecAsTest ajcTestAsSpec = new AjctestsAdapter.AjcTestSpecAsTest(spec, mAjctestsAdapter);
        ...
        private AjcTest.Spec getSpec(String description) {
            AjcTest.Spec spec = (AjcTest.Spec) mDescriptionToAjcTestSpec.get(description);
            if (null == spec) {
    ...
    private static class AjcTestSpecAsTest extends TestCase implements HarnessJUnitUtil.IHasAjcSpec {
