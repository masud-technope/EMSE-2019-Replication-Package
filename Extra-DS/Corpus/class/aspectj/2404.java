...
public class Statics {
     ...
     */
    public static String getPreQualifiedClassLink(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc cd, String where) {
     ...
     */
    public static void printPreQualifiedClassLink(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc cd, String where) {
