...
public class AnnotationPatternMatchingTestCase extends TestCase {
    ...
    public void testAnnotationPatternMatchingOnMethods() {
        if (LangUtil.is15VMOrGreater()) {
            ...
            assertTrue("@SimpleAnnotation should match on the AnnotatedClass.m1() method", simpleAnnotationTP.matches(aMethod).alwaysTrue());
        }
    }
    ...
    public void testAnnotationPatternMatchingOnFields() {
        if (LangUtil.is15VMOrGreater()) {
            ...
            assertTrue("@SimpleAnnotation should match on the AnnotatedClass.i field", simpleAnnotationTP.matches(aField).alwaysTrue());
        }
    }
