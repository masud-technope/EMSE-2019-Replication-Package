...
class DefaultTarget {
    ...
    public void publicMethod() {
        Util.signal(Util.defPublic);
    }

    protected void protectedMethod() {
        Util.signal(Util.defProtected);
    }

    void defaultMethod() {
        Util.signal(Util.defDefault);
    }

    private void privateMethod() {
        Util.signal(Util.defPrivate);
    }
    ...
    class DefaultInner {
        ...
        /* def */
        static final int defaultStaticDefaultInnerInt = 1;
        ...
        /* default */
        int defaultDefaultInnerInt = 1;

        private int privateDefaultInnerInt = 1;

        public void publicDefaultInnerMethod() {
            Util.signal(Util.defInnerPublic);
        }

        protected void protectedDefaultInnerMethod() {
            Util.signal(Util.defInnerProtected);
        }

        /* default */
        void defaultDefaultInnerMethod() {
            Util.signal(Util.defInnerDefault);
        }

        private void privateDefaultInnerMethod() {
            Util.signal(Util.defInnerPrivate);
        }
        ...
        public void readDefaultInnerTarget() {
            ...
            DefaultTarget.DefaultInner defaultInnerTarget = new DefaultTarget().new DefaultInner();
