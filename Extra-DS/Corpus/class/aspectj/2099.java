...
public class TernaryPrimitiveOps {
    ...
    public void realMain(String[] args) {
        ...
        for (int _i = 0; _i < _bytes.length; _i++) {
            if (_bytes[_i] != (byte) -1) {
                Tester.check(_bytes[_i] == (byte) 1, _bytes[_i] + " != 1");
            }
        }
        for (int _i = 0; _i < _chars.length; _i++) {
            if (_chars[_i] != (char) -1) {
                Tester.check(_chars[_i] == (char) 1, _chars[_i] + " != 1");
            }
        }
        for (int _i = 0; _i < _doubles.length; _i++) {
            if (_doubles[_i] != (double) -1) {
                Tester.check(_doubles[_i] == (double) 1, _doubles[_i] + " != 1");
            }
        }
        for (int _i = 0; _i < _ints.length; _i++) {
            if (_ints[_i] != (int) -1) {
                Tester.check(_ints[_i] == (int) 1, _ints[_i] + " != 1");
            }
        }
        for (int _i = 0; _i < _floats.length; _i++) {
            if (_floats[_i] != (float) -1) {
                Tester.check(_floats[_i] == (float) 1, _floats[_i] + " != 1");
            }
        }
        for (int _i = 0; _i < _longs.length; _i++) {
            if (_longs[_i] != (long) -1) {
                Tester.check(_longs[_i] == (long) 1, _longs[_i] + " != 1");
            }
        }
        for (int _i = 0; _i < _shorts.length; _i++) {
            if (_shorts[_i] != (short) -1) {
                Tester.check(_shorts[_i] == (short) 1, _shorts[_i] + " != 1");
            }
        }
    /*
byte
