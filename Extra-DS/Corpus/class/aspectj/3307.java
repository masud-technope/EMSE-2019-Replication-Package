...
public class DeclareSoftDeclaration extends DeclareDeclaration {
    ...
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = internalJavadocPropertyFactory(DeclareSoftDeclaration.class);

    public static final ChildPropertyDescriptor TYPE_PATTERN_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(DeclareSoftDeclaration.class, "typePattern", TypePattern.class, MANDATORY, NO_CYCLE_RISK);

    public static final ChildPropertyDescriptor POINTCUT_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(DeclareSoftDeclaration.class, "pointcut", PointcutDesignator.class, MANDATORY, NO_CYCLE_RISK);
