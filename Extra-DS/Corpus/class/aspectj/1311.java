...
public abstract class AbstractWorldTestCase extends TestCase {
    ...
    private final UnresolvedType[] primitiveTypeXs = UnresolvedType.forSignatures(new String[] { "B", "S", "C", "I", "J", "F", "D", "V" });
    ...
    public void testPrimitiveTypes() {
        ...
        for (int i = 0, len = primitives.length; i < len; i++) {
            ...
            for (int j = 0; j < len; j++) {
                ...
                } else if (ty == ResolvedType.BOOLEAN || ty1 == ResolvedType.BOOLEAN || ty == ResolvedType.VOID || ty1 == ResolvedType.VOID) {
    ...
    public void testPrimitiveArrays() {
        ...
        for (int i = 0, len = primitives.length; i < len; i++) {
            ...
            interfacesTest(aty, new ResolvedType[] { getWorld().getCoreType(UnresolvedType.CLONEABLE), getWorld().getCoreType(UnresolvedType.SERIALIZABLE) });
