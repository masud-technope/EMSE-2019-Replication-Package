...
public class Standard extends AbstractStandard {
    ...
    protected Class[] preGenerationClasses() {
        return new Class[] { ClassUseMapperPass.class, TreeWriterPass.class, SplitIndexWriterPass.class, SingleIndexWriterPass.class, DeprecatedListWriterPass.class, AllClassesFrameWriterPass.class, FrameOutputWriterPass.class, PackagesFileWriterPass.class, PackageIndexWriterPass.class, PackageIndexFrameWriterPass.class };
    }
    ...
    public static class HelpWriterPass extends Pass {
        ...
        protected boolean cond() {
            return cs.helpfile.length() == 0 && !cs.nohelp;
        }
    ...
    protected Class[] postGenerationClasses() {
        return new Class[] { SerializedFormWriterPass.class, PackageListWriterPass.class, HelpWriterPass.class, StylesheetWriterPass.class };
    }
    ...
    protected Class[] checkClasses() {
        return new Class[] { NoPublicClassesToDocumentCheck.class, NoNonDeprecatedClassToDocumentCheck.class };
    }
}
