 ...
 *
 * <p>$Id: ColumnScanEmitter.java,v 1.1 2002/05/15 17:22:28 isberg Exp $</p>
 *
 ...
 *
 * @version $Id: ColumnScanEmitter.java,v 1.1 2002/05/15 17:22:28 isberg Exp $
 *
 */
public class ColumnScanEmitter extends com.icl.saxon.output.Emitter {
    ...
    /** Discarded. */
    public void processingInstruction(java.lang.String name, java.lang.String data) throws TransformerException {
    // nop
    }
    ...
    public void startElement(int nameCode, org.xml.sax.Attributes attributes, int[] namespaces, int nscount) throws TransformerException {
        ...
        if (thisFingerprint == colFingerprint || thisFingerprint == foColFingerprint) {
