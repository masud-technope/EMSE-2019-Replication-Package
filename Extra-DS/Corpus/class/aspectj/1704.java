...
public class BcelCflowCounterFieldAdder extends BcelTypeMunger {
    ...
    public boolean munge(BcelClassWeaver weaver) {
        ...
        Field f = new FieldGen(cflowCounterField.getModifiers(), BcelWorld.makeBcelType(cflowCounterField.getReturnType()), cflowCounterField.getName(), gen.getConstantPoolGen()).getField();
