...
public class AspectDeclaration extends AjTypeDeclaration {
    ...
    public static final ChildPropertyDescriptor PERCLAUSE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AspectDeclaration.class, "perClause", ASTNode.class, OPTIONAL, NO_CYCLE_RISK);

    public static final SimplePropertyDescriptor PRIVILEGED_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(AspectDeclaration.class, "privileged", boolean.class, MANDATORY);
