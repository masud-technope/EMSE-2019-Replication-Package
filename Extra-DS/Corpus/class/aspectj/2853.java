...
public class AjTypeTests extends TestCase {
    ...
    public void testGetInterfaces() {
        ...
        for (int i = 0; i < i1.length; i++) assertEquals(i1[i], i2[i].getJavaClass());
    }
    ...
    public void testGetConstructors() {
        ...
        for (int i = 0; i < c1.length; i++) assertEquals(c1[i], c2[i]);
    }
    ...
    public void testGetDeclaredFields() {
        ...
        for (int i = 0; i < f1.length; i++) assertEquals(f1[i], f2[i]);
    }
    ...
    public void testGetDeclaredMethods() {
        ...
        for (int i = 0; i < m1.length; i++) assertEquals(m1[i], m2[i]);
    }
...
class Foo<T> {
    ...
    public  Foo() {
        ...
        if (!c.getName().equals("org.aspectj.internal.lang.reflect.Foo"))
            throw new RuntimeException("should have been Foo");
    }
