...
public class DeclareSoft extends Declare {
    ...
    public Declare parameterizeWith(Map typeVariableBindingMap) {
        DeclareSoft ret = new DeclareSoft(exception.parameterizeWith(typeVariableBindingMap), pointcut.parameterizeWith(typeVariableBindingMap));
    ...
    public void resolve(IScope scope) {
        ...
        if (!excType.isMissing()) {
            ...
            if (!scope.getWorld().getCoreType(UnresolvedType.THROWABLE).isAssignableFrom(excType)) {
                scope.getWorld().showMessage(IMessage.ERROR, WeaverMessages.format(WeaverMessages.NOT_THROWABLE, excType.getName()), exception.getSourceLocation(), null);
