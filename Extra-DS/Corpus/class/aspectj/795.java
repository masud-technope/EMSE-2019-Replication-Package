...
public class SavedModelConsistencyTest extends AjdeTestCase {
    ...
    public void testInterfaceIsSameInBoth() {
        ...
        assertTrue("Nodes should be identical: Prebuild kind = " + nodePreBuild.getKind() + "   Postbuild kind = " + nodePostBuild.getKind(), nodePreBuild.getKind().equals(nodePostBuild.getKind()));
    }
