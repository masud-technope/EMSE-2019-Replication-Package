...
public class AjBuildConfig {
    ...
    private /*String->File*/
    Map sourcePathResources = new HashMap();
	 ...
	 */
    public List getBinaryFiles() /*BinarySourceFile*/
    {
        return binaryFiles;
    }
	 ...
	 */
    public // XXX setters don't respect javadoc contract...
    List getClasspath() {
        return classpath;
    }
    ...
    public List getFullClasspath() {
        ...
        // XXX Is it OK that boot classpath overrides inpath/injars/aspectpath?
