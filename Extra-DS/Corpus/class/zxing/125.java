...
public class ContactInfoGenerator implements GeneratorSource {
    ...
    public  ContactInfoGenerator(ChangeListener changeListener, KeyPressHandler keyListener) {
    ...
    private String getMeCard(String name, String tel, String url, String email, String address, String address2, String memo) {
        StringBuilder output = new StringBuilder();
        output.append("MECARD:");
        // remove commas -- reserved char in MECARD
        name = name.replace(",", "");
