...
public class PointcutDesignatorHandlerBasedPointcut extends Pointcut {
    ...
    public  PointcutDesignatorHandlerBasedPointcut(ContextBasedMatcher expr, ReflectionWorld world) {
        this.matcher = expr;
        this.world = world;
    }
    ...
    public FuzzyBoolean fastMatch(FastMatchInfo info) {
        if (info instanceof ReflectionFastMatchInfo) {
            try {
                return FuzzyBoolean.fromBoolean(this.matcher.couldMatchJoinPointsInType(Class.forName(info.getType().getName(), false, world.getClassLoader()), ((ReflectionFastMatchInfo) info).getMatchingContext()));
