...
public class AjcMemberMaker {
    ...
    public static final UnresolvedType CONVERSIONS_TYPE = UnresolvedType.forName("org.aspectj.runtime.internal.Conversions");

    public static final UnresolvedType NO_ASPECT_BOUND_EXCEPTION = UnresolvedType.forName("org.aspectj.lang.NoAspectBoundException");
    ...
    public static Member noAspectBoundExceptionInit2() {
        return new ResolvedMemberImpl(Member.METHOD, NO_ASPECT_BOUND_EXCEPTION, Modifier.PUBLIC, "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V");
    }
    ...
    public static ResolvedMember perCflowField(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.FIELD, declaringType, PUBLIC_STATIC_FINAL, NameMangler.PERCFLOW_FIELD_NAME, CFLOW_STACK_TYPE.getSignature());
    }

    public static ResolvedMember perSingletonField(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.FIELD, declaringType, PUBLIC_STATIC_FINAL, NameMangler.PERSINGLETON_FIELD_NAME, declaringType.getSignature());
    }

    public static ResolvedMember initFailureCauseField(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.FIELD, declaringType, PRIVATE_STATIC, NameMangler.INITFAILURECAUSE_FIELD_NAME, UnresolvedType.THROWABLE.getSignature());
    }
    ...
    public static ResolvedMember perTypeWithinWithinTypeField(UnresolvedType declaringType, ResolvedType aspectType) {
        ...
        return new ResolvedMemberImpl(Member.FIELD, declaringType, modifiers, UnresolvedType.forSignature("Ljava/lang/String;"), NameMangler.PERTYPEWITHIN_WITHINTYPEFIELD, UnresolvedType.NONE);
    }
    ...
    public static ResolvedMember perObjectBind(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.METHOD, declaringType, PUBLIC_STATIC, NameMangler.PEROBJECT_BIND_METHOD, "(Ljava/lang/Object;)V");
    }
    ...
    public static ResolvedMember perTypeWithinGetInstance(UnresolvedType declaringType) {
        ...
        ResolvedMemberImpl rm = new ResolvedMemberImpl(Member.METHOD, declaringType, PRIVATE_STATIC, // return value
        declaringType, NameMangler.PERTYPEWITHIN_GETINSTANCE_METHOD, new UnresolvedType[] { UnresolvedType.JAVA_LANG_CLASS });
        return rm;
    }
    ...
    public static ResolvedMember perTypeWithinCreateAspectInstance(UnresolvedType declaringType) {
        ...
        ResolvedMemberImpl rm = new ResolvedMemberImpl(Member.METHOD, declaringType, PUBLIC_STATIC, // return value
        declaringType, NameMangler.PERTYPEWITHIN_CREATEASPECTINSTANCE_METHOD, new UnresolvedType[] { UnresolvedType.forSignature("Ljava/lang/String;") }, new UnresolvedType[] {});
        return rm;
    }
    ...
    public static ResolvedMember perObjectInterfaceGet(UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.METHOD, perObjectInterfaceType(aspectType), Modifier.PUBLIC | Modifier.ABSTRACT, NameMangler.perObjectInterfaceGet(aspectType), "()" + aspectType.getSignature());
    }

    public static ResolvedMember perObjectInterfaceSet(UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.METHOD, perObjectInterfaceType(aspectType), Modifier.PUBLIC | Modifier.ABSTRACT, NameMangler.perObjectInterfaceSet(aspectType), "(" + aspectType.getSignature() + ")V");
    }
    ...
    public static ResolvedMember perTypeWithinLocalAspectOf(UnresolvedType shadowType, UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.METHOD, //perTypeWithinInterfaceType(aspectType),
        shadowType, Modifier.PUBLIC | Modifier.STATIC, NameMangler.perTypeWithinLocalAspectOf(aspectType), "()" + aspectType.getSignature());
    }
    ...
    public static ResolvedMember perObjectAspectOfMethod(UnresolvedType declaringType) {
        return new ResolvedMemberImpl(Member.METHOD, declaringType, PUBLIC_STATIC, "aspectOf", "(Ljava/lang/Object;)" + declaringType.getSignature());
    }
    ...
    public static ResolvedMember perTypeWithinAspectOfMethod(UnresolvedType declaringType, boolean inJava5Mode) {
        ...
        return new ResolvedMemberImpl(Member.METHOD, declaringType, PUBLIC_STATIC, declaringType, "aspectOf", new UnresolvedType[] { parameterType });
    ...
    public static ResolvedMember perTypeWithinHasAspectMethod(UnresolvedType declaringType, boolean inJava5Mode) {
        ...
        return new ResolvedMemberImpl(Member.METHOD, declaringType, PUBLIC_STATIC, ResolvedType.BOOLEAN, "hasAspect", new UnresolvedType[] { parameterType });
    //		return new ResolvedMemberImpl(Member.METHOD,
    ...
    public static ResolvedMember privilegedAccessMethodForMethod(UnresolvedType aspectType, ResolvedMember method) {
        return new ResolvedMemberImpl(Member.METHOD, method.getDeclaringType(), Modifier.PUBLIC | (method.isStatic() ? Modifier.STATIC : 0), method.getReturnType(), NameMangler.privilegedAccessMethodForMethod(method.getName(), method.getDeclaringType(), aspectType), method.getParameterTypes(), method.getExceptions());
    }
    ...
    public static ResolvedMember privilegedAccessMethodForFieldGet(UnresolvedType aspectType, Member field) {
        ...
        return new ResolvedMemberImpl(Member.METHOD, field.getDeclaringType(), //Modifier.PUBLIC | (field.isStatic() ? Modifier.STATIC : 0),
        PUBLIC_STATIC, NameMangler.privilegedAccessMethodForFieldGet(field.getName(), field.getDeclaringType(), aspectType), sig);
    }
    ...
    public static ResolvedMember privilegedAccessMethodForFieldSet(UnresolvedType aspectType, Member field) {
        ...
        return new ResolvedMemberImpl(Member.METHOD, field.getDeclaringType(), //Modifier.PUBLIC | (field.isStatic() ? Modifier.STATIC : 0),
        PUBLIC_STATIC, NameMangler.privilegedAccessMethodForFieldSet(field.getName(), field.getDeclaringType(), aspectType), sig);
    }
    ...
    public static ResolvedMember superAccessMethod(UnresolvedType baseType, ResolvedMember method) {
        return new ResolvedMemberImpl(Member.METHOD, baseType, Modifier.PUBLIC, method.getReturnType(), NameMangler.superDispatchMethod(baseType, method.getName()), method.getParameterTypes(), method.getExceptions());
    }
    ...
    public static ResolvedMember inlineAccessMethodForMethod(UnresolvedType aspectType, ResolvedMember method) {
        ...
        return new ResolvedMemberImpl(Member.METHOD, aspectType, //??? what about privileged and super access
        PUBLIC_STATIC, //???Modifier.PUBLIC | (method.isStatic() ? Modifier.STATIC : 0),
        method.getReturnType(), NameMangler.inlineAccessMethodForMethod(method.getName(), method.getDeclaringType(), aspectType), paramTypes, method.getExceptions());
    }
    ...
    public static ResolvedMember inlineAccessMethodForFieldGet(UnresolvedType aspectType, Member field) {
        ...
        return new ResolvedMemberImpl(Member.METHOD, aspectType, //Modifier.PUBLIC | (field.isStatic() ? Modifier.STATIC : 0),
        PUBLIC_STATIC, NameMangler.inlineAccessMethodForFieldGet(field.getName(), field.getDeclaringType(), aspectType), sig);
    }
    ...
    public static ResolvedMember inlineAccessMethodForFieldSet(UnresolvedType aspectType, Member field) {
        ...
        return new ResolvedMemberImpl(Member.METHOD, aspectType, //Modifier.PUBLIC | (field.isStatic() ? Modifier.STATIC : 0),
        PUBLIC_STATIC, NameMangler.inlineAccessMethodForFieldSet(field.getName(), field.getDeclaringType(), aspectType), sig);
    }
    ...
    public static ResolvedMember preIntroducedConstructor(UnresolvedType aspectType, UnresolvedType targetType, UnresolvedType[] paramTypes) {
        return new ResolvedMemberImpl(Member.METHOD, aspectType, PUBLIC_STATIC_FINAL, UnresolvedType.OBJECTARRAY, NameMangler.preIntroducedConstructor(aspectType, targetType), paramTypes);
    }
    ...
    public static ResolvedMember postIntroducedConstructor(UnresolvedType aspectType, UnresolvedType targetType, UnresolvedType[] paramTypes) {
        return new ResolvedMemberImpl(Member.METHOD, aspectType, PUBLIC_STATIC_FINAL, ResolvedType.VOID, NameMangler.postIntroducedConstructor(aspectType, targetType), UnresolvedType.insert(targetType, paramTypes));
    }
    ...
    public static ResolvedMember itdAtDeclareParentsField(ResolvedType targetType, UnresolvedType itdType, UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.FIELD, targetType, Modifier.PRIVATE, itdType, NameMangler.itdAtDeclareParentsField(aspectType, itdType), null);
    }
    ...
    public static ResolvedMember interConstructor(ResolvedType targetType, ResolvedMember constructor, UnresolvedType aspectType) {
        ...
        //		int modifiers) 
        //	{
        ResolvedMember ret = new ResolvedMemberImpl(Member.CONSTRUCTOR, targetType, Modifier.PUBLIC, ResolvedType.VOID, "<init>", constructor.getParameterTypes(), constructor.getExceptions());
    ...
    public static ResolvedMember interFieldInitializer(ResolvedMember field, UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.METHOD, aspectType, PUBLIC_STATIC, NameMangler.interFieldInitializer(aspectType, field.getDeclaringType(), field.getName()), field.isStatic() ? "()V" : "(" + field.getDeclaringType().getSignature() + ")V");
    }
    ...
    public static ResolvedMember interFieldSetDispatcher(ResolvedMember field, UnresolvedType aspectType) {
        ResolvedMember rm = new ResolvedMemberImpl(Member.METHOD, aspectType, PUBLIC_STATIC, ResolvedType.VOID, NameMangler.interFieldSetDispatcher(aspectType, field.getDeclaringType(), field.getName()), field.isStatic() ? new UnresolvedType[] { field.getReturnType() } : new UnresolvedType[] { field.getDeclaringType(), field.getReturnType() });
    ...
    public static ResolvedMember interFieldGetDispatcher(ResolvedMember field, UnresolvedType aspectType) {
        ResolvedMember rm = new ResolvedMemberImpl(Member.METHOD, aspectType, PUBLIC_STATIC, field.getReturnType(), NameMangler.interFieldGetDispatcher(aspectType, field.getDeclaringType(), field.getName()), field.isStatic() ? UnresolvedType.NONE : new UnresolvedType[] { field.getDeclaringType() }, UnresolvedType.NONE);
        rm.setTypeVariables(field.getTypeVariables());
        return rm;
    }
    ...
    public static ResolvedMember interFieldClassField(ResolvedMember field, UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.FIELD, field.getDeclaringType(), makePublicNonFinal(field.getModifiers()), field.getReturnType(), NameMangler.interFieldClassField(field.getModifiers(), aspectType, field.getDeclaringType(), field.getName()), UnresolvedType.NONE, UnresolvedType.NONE);
    }
    ...
    public static ResolvedMember interFieldInterfaceField(ResolvedMember field, UnresolvedType onClass, UnresolvedType aspectType) {
        return new ResolvedMemberImpl(Member.FIELD, onClass, makePublicNonFinal(field.getModifiers()), field.getReturnType(), NameMangler.interFieldInterfaceField(aspectType, field.getDeclaringType(), field.getName()), UnresolvedType.NONE, UnresolvedType.NONE);
    }
    ...
    public static ResolvedMember interFieldInterfaceSetter(ResolvedMember field, ResolvedType onType, UnresolvedType aspectType) {
        ...
        ResolvedMember rm = new ResolvedMemberImpl(Member.METHOD, onType, modifiers, ResolvedType.VOID, NameMangler.interFieldInterfaceSetter(aspectType, field.getDeclaringType(), field.getName()), new UnresolvedType[] { field.getReturnType() }, UnresolvedType.NONE);
        rm.setTypeVariables(field.getTypeVariables());
        return rm;
    }
    ...
    public static ResolvedMember interMethodDispatcher(ResolvedMember meth, UnresolvedType aspectType) {
        ...
        ResolvedMemberImpl rmi = new ResolvedMemberImpl(Member.METHOD, aspectType, PUBLIC_STATIC, meth.getReturnType(), NameMangler.interMethodDispatcher(aspectType, meth.getDeclaringType(), meth.getName()), paramTypes, meth.getExceptions());
        rmi.setTypeVariables(meth.getTypeVariables());
        return rmi;
    }
    ...
    public static ResolvedMember toObjectConversionMethod(UnresolvedType fromType) {
        if (fromType.isPrimitiveType()) {
            ...
            return new ResolvedMemberImpl(Member.METHOD, CONVERSIONS_TYPE, PUBLIC_STATIC, UnresolvedType.OBJECT, name, new UnresolvedType[] { fromType }, UnresolvedType.NONE);
        } else {
            return null;
        }
    }
    ...
    public static final UnresolvedType ASPECT_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.Aspect");

    public static final UnresolvedType BEFORE_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.Before");

    public static final UnresolvedType AROUND_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.Around");

    public static final UnresolvedType AFTERRETURNING_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.AfterReturning");

    public static final UnresolvedType AFTERTHROWING_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.AfterThrowing");

    public static final UnresolvedType AFTER_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.After");

    public static final UnresolvedType POINTCUT_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.Pointcut");

    public static final UnresolvedType DECLAREERROR_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.DeclareError");

    public static final UnresolvedType DECLAREWARNING_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.DeclareWarning");

    public static final UnresolvedType DECLAREPRECEDENCE_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.DeclarePrecedence");

    public static final UnresolvedType DECLAREIMPLEMENTS_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.DeclareImplements");

    public static final UnresolvedType DECLAREPARENTS_ANNOTATION = UnresolvedType.forName("org.aspectj.lang.annotation.DeclareParents");

    public static final UnresolvedType TYPEX_JOINPOINT = UnresolvedType.forName(JoinPoint.class.getName().replace('/', '.'));

    public static final UnresolvedType TYPEX_PROCEEDINGJOINPOINT = UnresolvedType.forName(ProceedingJoinPoint.class.getName().replace('/', '.'));

    public static final UnresolvedType TYPEX_STATICJOINPOINT = UnresolvedType.forName(JoinPoint.StaticPart.class.getName().replace('/', '.'));

    public static final UnresolvedType TYPEX_ENCLOSINGSTATICJOINPOINT = UnresolvedType.forName(JoinPoint.EnclosingStaticPart.class.getName().replace('/', '.'));
}
