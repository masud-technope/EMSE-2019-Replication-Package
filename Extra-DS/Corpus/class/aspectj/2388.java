...
public class FieldIntroductionSubWriter extends FieldSubWriter {
    ...
    public  FieldIntroductionSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, AspectDoc ad) {
        super(writer, ad);
    }

    public  FieldIntroductionSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }

    protected final String keyName() {
        return "Field_Introduction";
    }
    ...
    public void printCrosscuts(ClassDoc cd, ProgramElementDoc member) {
        ...
        if (targets.length > 0) {
            ...
            for (int i = 0; i < targets.length; i++) {
                ...
                writer.printClassLink(target, "fields_introduced_from_class_" + cd.qualifiedName(), target.name());
            }
            writer.codeEnd();
