...
public class NullIdeTaskListManager implements TaskListManager {
    ...
    public void addSourcelineTask(IMessage message) {
        ...
        if (null != message.getSourceLocation()) {
            System.out.println("NullIde> task: " + message.getMessage() + ", file: " + message.getSourceLocation().getSourceFile().getAbsolutePath() + ": " + message.getSourceLocation().getLine());
        } else {
    ...
    public static class SourceLineTask {
        ...
        public String toString() {
            ...
            return "SourceLineTask [" + message.getMessage() + ", " + loc + ", " + message.getKind() + "]";
        }
    }
}
