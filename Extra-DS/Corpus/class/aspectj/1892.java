...
class Robot extends Pilot implements Runnable {
    ...
    public void run() {
        ...
        while (runnable) {
            ...
            double dx, dy, angleA, angleB, theta, dtheta, d, targetVel, a, b, c, targetXVel, targetYVel;
            while (true) {
                ...
                targetVel = Math.sqrt(targetXVel * targetXVel + targetYVel * targetYVel);
                ...
                } else // otherwise, fire, maybe even a burst
                {
