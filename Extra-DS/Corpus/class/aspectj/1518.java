    ...
    */
    ...
    public boolean canAccess(TypeDec dec) {
        ...
        if (result) {
            ...
            TypeDec outer = (null == outerType ? null : // todo: typeDec?
            outerType.getTypeDec());
    ...
    public final String toString() {
        return optionName.toUpperCase();
    }

    /** subclasses implement semantics here. */
    protected abstract boolean doCanAccess(Modifiers mods, Object object);
}
