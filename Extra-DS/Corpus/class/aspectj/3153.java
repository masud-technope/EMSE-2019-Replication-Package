 ...
 *
 * <p>$Id: NumberLinesEmitter.java,v 1.1 2002/05/15 17:22:27 isberg Exp $</p>
 *
 ...
 *
 * @version $Id: NumberLinesEmitter.java,v 1.1 2002/05/15 17:22:27 isberg Exp $
 *
 */
public class NumberLinesEmitter extends CopyEmitter {
   ...
   */
    public  NumberLinesEmitter(NamePool namePool, int modulus, int width, String separator, boolean foStylesheet) {
        super(namePool);
