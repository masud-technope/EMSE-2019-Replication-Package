...
public class PossibleGenericsSigs {
    ...
    <T extends Object & Comparable<? super T>> T s(Collection<T> col) {
        return null;
    }

    static <T extends Comparable<? super Number>> T t(Collection<T> col) {
        return null;
    }

    static <T extends Comparable<T>> T u(Collection<T> col) {
        return null;
    }

    <X> X v(Collection<X> x) {
        return null;
    }
