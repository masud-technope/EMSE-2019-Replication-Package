...
public class IteratorWrapperTest extends TestCase {
    ...
    public void testIteratorWrapper() {
        ...
        in = new List[] { List_ab };
        exp = new Object[][] { new Object[] { "a" }, new Object[] { "b" } };
        checkIteratorWrapper(in, exp);
        in = new List[] { one, List_ab };
        exp = new Object[][] { new Object[] { "1", "a" }, new Object[] { "1", "b" } };
        checkIteratorWrapper(in, exp);
        Object[] RA_cd = new String[] { "c", "d" };
        List List_cd = Collections.unmodifiableList(Arrays.asList(RA_cd));
        in = new List[] { List_ab, List_cd };
        exp = new Object[][] { new Object[] { "a", "c" }, new Object[] { "b", "c" }, new Object[] { "a", "d" }, new Object[] { "b", "d" } };
        checkIteratorWrapper(in, exp);
        in = new List[] { one, one, one };
        exp = new Object[][] { new Object[] { "1", "1", "1" } };
        checkIteratorWrapper(in, exp);
        in = new List[] { List_ab, List_ab, List_ab };
        exp = new Object[][] { new Object[] { "a", "a", "a" }, new Object[] { "b", "a", "a" }, new Object[] { "a", "b", "a" }, new Object[] { "b", "b", "a" }, new Object[] { "a", "a", "b" }, new Object[] { "b", "a", "b" }, new Object[] { "a", "b", "b" }, new Object[] { "b", "b", "b" } };
        checkIteratorWrapper(in, exp);
        in = new List[] { one, List_ab, List_ab };
        exp = new Object[][] { new Object[] { "1", "a", "a" }, new Object[] { "1", "b", "a" }, new Object[] { "1", "a", "b" }, new Object[] { "1", "b", "b" } };
        checkIteratorWrapper(in, exp);
        in = new List[] { one, List_ab, one };
        exp = new Object[][] { new Object[] { "1", "a", "1" }, new Object[] { "1", "b", "1" } };
        checkIteratorWrapper(in, exp);
        in = new List[] { List_ab, one, List_ab };
        exp = new Object[][] { new Object[] { "a", "1", "a" }, new Object[] { "b", "1", "a" }, new Object[] { "a", "1", "b" }, new Object[] { "b", "1", "b" } };
        checkIteratorWrapper(in, exp);
