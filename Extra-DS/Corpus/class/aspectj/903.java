...
public class ReferencePointcut extends Pointcut {
    ...
    public void resolveBindings(IScope scope, Bindings bindings) {
        ...
        if (parameterTypes.length != arguments.size()) {
            scope.message(IMessage.ERROR, this, "incompatible number of arguments to pointcut, expected " + parameterTypes.length + " found " + arguments.size());
            return;
        }
        ...
        for (int i = 0, len = arguments.size(); i < len; i++) {
            ...
            if (reportProblem) {
                scope.message(IMessage.ERROR, p, "incompatible type, expected " + parameterTypes[i].getName() + " found " + p + ".  Check the type specified in your pointcut");
                return;
            }
        }
    }
    ...
    public Pointcut concretize1(ResolvedType searchStart, ResolvedType declaringType, IntMap bindings) {
        ...
        try {
            ...
            if (!foundMatchingPointcut) {
                ...
                if (pointcutDec == null) {
                    searchStart.getWorld().getMessageHandler().handleMessage(MessageUtil.error(WeaverMessages.format(WeaverMessages.CANT_FIND_POINTCUT, name, searchStart.getName()), getSourceLocation()));
                    return Pointcut.makeMatchesNothing(Pointcut.CONCRETE);
                }
            }
    ...
    public boolean equals(Object other) {
        ...
        return o.name.equals(name) && o.arguments.equals(arguments) && ((o.onType == null) ? (onType == null) : o.onType.equals(onType));
    }
