...
public class OptionsTest extends TestCase {
    ...
    private static Options getOptions() {
        if (null == OPTIONS) {
            ...
            OPTIONS.addOption(factory.create("warn", "warning", Option.STANDARD_PREFIXES, true));
    ...
    public void testNegDebugCase() {
        ...
        optionChecker.checkOptionsNegative(input, expectedInValuesException, expectedMissedMatchErr, expectedResolveErr);
    }
    ...
    public void testOptionsPositive() {
        ...
        input = new String[] { "!ajdeCompiler", "^ajc" };
        optionChecker.checkOptions(input, expected);
        input = new String[] { "-verbose", "^verbose", "!quiet", "-quiet", "-debug", "^debug" };
        expected = new String[] { "-quiet" };
        optionChecker.checkOptions(input, expected);
        input = new String[] { "-verbose", "^debug", "!quiet", "!quiet", "-debug", "^verbose" };
        expected = new String[] { "-quiet" };
        optionChecker.checkOptions(input, expected);
    }
    ...
    public void testOptionsNegative() {
        ...
        String expectedResolveErr = null;
        optionChecker.checkOptionsNegative(input, expectedMissedMatchErr, expectedResolveErr);
        input = new String[] { "!verbose", "^verbose" };
    ...
    public void testMissedMatches() throws InvalidInputException {
        ...
        Option multiple = factory.create("source", "source", Option.STANDARD_PREFIXES, false, new String[][] { new String[] { "1.3", "1.4" } });
    ...
    void checkMissedMatches(int[] expected, Values actual) {
        ...
        if (failed) {
            assertTrue("expected " + Values.IntList.render(expected) + " got " + Values.IntList.render(result) + " for " + actual, false);
        }
    }
    ...
    public void testMultiArgOptionsPositive() {
        ...
        optionChecker.checkOptions(input, expected);
        input = new String[] { "-source", "1.3", "^source", "1.4" };
        input = new String[] { "-source", "1.3", "^source", "1.4", "!source", "1.3", "-source", "1.4" };
        optionChecker.checkOptions(input, expected);
    }
    ...
    public void testMultiArgOptionsNegative() {
        ...
        optionChecker.checkOptionsNegative(input, expectedException, null, null);
    ...
    public void testMultipleInput() {
        OptionChecker optionChecker = getOptionChecker();
        String[][] input = new String[][] { new String[] { "-warn:deprecated" }, new String[] { "-warn:deprecated,unverified" }, new String[] { "-warn:deprecated", "-warn:unusedLocals" }, new String[] { "-g" }, new String[] { "-g", "-g:none" }, new String[] { "-g:vars,source" }, new String[] { "-verbose", "-g:vars,source" } };
