...
public class Ajdoc extends // XXX disabled pending ajdoc implementation
Task {
}
//
...
//        set(flag, project.resolveFile(file).getAbsolutePath());
//    }
//
...
//        this.packageList = project.resolveFile(packageList);
//    }
//
...
//        createArgfiles().add(project.resolveFile(argfile));
//    }
//
...
//        if (ispace == -1) {
//            throw new BuildException("linkoffline usage: <url> <url2>!", location);
//        }
...
//                    ("group usage: group=[<title> <pkglist>]*", location);
//            }
//        }
//    }
//    
...
//            if (link.href == null) {
//                throw new BuildException("Link href cannot be null!", location);
//            }
...
//        if (doclet != null) {
//            if (doclet.name == null) {
//                throw new BuildException("Doclet name cannot be null!", location);
//            }
...
//            }
//            return Main.execute(args); // todo: direct to new Ajdoc().execute(..)?
//        } catch (Throwable t) {
