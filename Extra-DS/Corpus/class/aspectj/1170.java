...
public class ThrowsPattern extends PatternNode {
    ...
    public ThrowsPattern parameterizeWith(Map /*name -> resolved type*/
    typeVariableMap) {
        ThrowsPattern ret = new ThrowsPattern(required.parameterizeWith(typeVariableMap), forbidden.parameterizeWith(typeVariableMap));
