...
public class DeclareAtConstructorDeclaration extends DeclareAnnotationDeclaration {
    ...
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = internalJavadocPropertyFactory(DeclareAtConstructorDeclaration.class);

    public static final ChildPropertyDescriptor PATTERN_PROPERTY = internalPatternNodePropertyFactory(DeclareAtConstructorDeclaration.class);

    public static final ChildPropertyDescriptor ANNOTATION_NAME_PROPERTY = internalAnnotationNamePropertyFactory(DeclareAtConstructorDeclaration.class);
