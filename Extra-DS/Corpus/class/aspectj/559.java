...
public class AsmHierarchyBuilderExtensionTest extends AjdeTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        // NOTE that we set our builder here
        AjBuildManager.setAsmHierarchyBuilder(builder);
...
class ExtendedAsmHiearchyBuilder extends AsmHierarchyBuilder {
    ...
    public boolean visit(MessageSend messageSend, BlockScope scope) {
        IProgramElement peNode = new ProgramElement(new String(">>> found call: " + messageSend.toString()), IProgramElement.Kind.CODE, //makeLocation(messageSend),
