...
public class FinalFields implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!Modifier.isFinal(mods))
            throw new RuntimeException("modifier should be final");
        if (!Modifier.isPublic(mods))
            throw new RuntimeException("modifier should be public");
        if (!Modifier.isStatic(mods))
            throw new RuntimeException("modifier should be static");
    }
}
