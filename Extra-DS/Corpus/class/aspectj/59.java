 ...
 *
 * <p>$Id: Table.java,v 1.1 2002/05/15 17:22:27 isberg Exp $</p>
 *
 ...
 *
 * @version $Id: Table.java,v 1.1 2002/05/15 17:22:27 isberg Exp $
 *
 */
public class Table {
   ...
   */
    public static NodeSetValue adjustColumnWidths(Context context, NodeSetValue rtf_ns) {
        ...
        try {
            ...
            ColumnUpdateEmitter cuEmitter = new ColumnUpdateEmitter(namePool, widths);
