...
public class LocalVariableTypeTableTest extends BcelTestCase {
    ...
    public void testLocalVariableTypeTableAttribute() throws ClassNotFoundException {
        ...
        LocalVariableTypeTable localVariableTypeTable = (LocalVariableTypeTable) findAttribute("LocalVariableTypeTable", codeAttr.getAttributes());
        assertTrue("Should be two entries in the LocalVariableTypeTable but found " + localVariableTypeTable.getTableLength(), localVariableTypeTable.getTableLength() == 2);
