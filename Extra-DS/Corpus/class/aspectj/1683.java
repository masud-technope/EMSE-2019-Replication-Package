...
public class AjdocTaskTester extends AntTaskTester {
    ...
    protected static final String TEST_DOCDIR = "test-docs";
    ...
    public void test_nodeprecated_no() {
        wantFiles("One.html");
    }

    public void test_nodeprecated_yes() {
        wantFiles("One.html");
    }
    ...
    public void test_author_no() {
        wantFiles("One.html");
    }

    public void test_author_yes() {
        wantFiles("One.html");
    }

    public void test_public_no() {
        wantFiles("One.html");
    }

    public void test_public_yes() {
        wantFiles("One.html");
    }

    public void test_package_no() {
        wantFiles("One.html");
    }

    public void test_package_yes() {
        wantFiles("One.html");
    }

    public void test_protected_no() {
        wantFiles("One.html");
    }

    public void test_protected_yes() {
        wantFiles("One.html");
    }

    public void test_private_no() {
        wantFiles("One.html");
    }

    public void test_private_yes() {
        wantFiles("One.html");
    }
    ...
    ////// End tests ////////////////////////////////////////////////
    private static final int OVERVIEW_TREE_HTML = 0x000001;

    private static final int INDEX_ALL_HTML = 0x000002;

    private static final int DEPRECATED_LIST_HTML = 0x000004;

    private static final int ALLCLASSES_FRAME_HTML = 0x000008;

    private static final int INDEX_HTML = 0x000010;

    private static final int PACKAGES_HTML = 0x000020;

    private static final int OVERVIEW_SUMMARY_HTML = 0x000040;

    private static final int PACKAGE_LIST = 0x000080;

    private static final int HELP_DOC_HTML = 0x000100;

    private static final int STYLESHEET_CSS = 0x000200;

    private static final int ALL = 0x0003ff;

    private static final int TOP = ((ALL << 1) | 1) & ~ALL;

    private static final String[] FILES = new String[] { "overview-tree.html", "index-all.html", "deprecated-list.html", "allclasses-frame.html", "index.html", "packages.html", "overview-summary.html", "package-list", "help-doc.html", "stylesheet.css" };
    ...
    protected void avoidFiles(String filesWithoutHtmlExtensions) {
        ...
        for (StringTokenizer tok = new StringTokenizer(filesWithoutHtmlExtensions, " ,;"); tok.hasMoreTokens(); ) {
