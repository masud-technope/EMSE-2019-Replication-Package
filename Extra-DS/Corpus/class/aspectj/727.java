...
public class AjdeInteractionTestbed extends TestCase {
    ...
    public static void configureBuildStructureModel(boolean b) {
        buildModel = b;
    }
    ...
    public static class AjdeManager {
        ...
        static {
            Ajde.init(null, MyTaskListManager.getInstance(), MyBuildProgressMonitor.getInstance(), MyProjectPropertiesAdapter.getInstance(), MyBuildOptionsAdapter.getInstance(), null, null, MyErrorHandler.getInstance());
    ...
    static class MyBuildProgressMonitor implements BuildProgressMonitor {
        ...
        public static List getCompiledFiles() {
            return _instance.compiledFiles;
        }

        public static List getWovenClasses() {
            return _instance.wovenClasses;
        }
