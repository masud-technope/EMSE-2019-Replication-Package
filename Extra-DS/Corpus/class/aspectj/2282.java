...
public class DeclareErrorDeclaration extends DeclareDeclaration {
    ...
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = internalJavadocPropertyFactory(DeclareErrorDeclaration.class);

    public static final ChildPropertyDescriptor POINTCUT_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(DeclareErrorDeclaration.class, "pointcut", PointcutDesignator.class, MANDATORY, NO_CYCLE_RISK);

    public static final ChildPropertyDescriptor MESSAGE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(DeclareErrorDeclaration.class, "message", StringLiteral.class, MANDATORY, NO_CYCLE_RISK);
