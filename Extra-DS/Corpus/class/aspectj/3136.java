...
public class BuildOptionsPanel extends OptionsPanel {
    ...
    private void jbInit() throws Exception {
        titledBorder1 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(156, 156, 158)), "ajc Options");
        BorderFactory.createCompoundBorder(new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(156, 156, 158)), "ajc Options"), BorderFactory.createEmptyBorder(5, 5, 5, 5));
