...
public class FieldSubWriter extends AbstractSubWriter {
    ...
    public static class Del extends com.sun.tools.doclets.standard.FieldSubWriter {
        ...
        public  Del(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc classdoc) {
        ...
        public void setDelegator(FieldSubWriter mw) {
            this.mw = mw;
        }
    ...
    public  FieldSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc classdoc) {
        super(writer, classdoc);
    }

    public  FieldSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }
    ...
    public void printCrosscuts(ClassDoc cd, ProgramElementDoc member) {
        ...
        if (intro != null) {
            ...
            writer.dd();
            writer.printClassLink(intro.containingClass(), Statics.where(intro.member()));
        }
    }
