...
public final class Code extends Attribute {
   ...
   */
    public LineNumberTable getLineNumberTable() {
        for (int i = 0; i < attributes_count; i++) if (attributes[i] instanceof LineNumberTable)
   ...
   */
    public LocalVariableTable getLocalVariableTable() {
        for (int i = 0; i < attributes_count; i++) if (attributes[i] instanceof LocalVariableTable)
   ...
   */
    private final int calculateLength() {
        int len = 0;
        for (int i = 0; i < attributes_count; i++) len += attributes[i].length + 6;
   ...
   */
    public Attribute copy(ConstantPool constant_pool) {
        ...
        for (int i = 0; i < exception_table_length; i++) c.exception_table[i] = exception_table[i].copy();
        c.attributes = new Attribute[attributes_count];
        for (int i = 0; i < attributes_count; i++) c.attributes[i] = attributes[i].copy(constant_pool);
        return c;
    }
}
