    ...
    private void every_class_has_an_accessible_superclass() {
        ...
        while (supidx != 0) {
            ...
            if (supidx == 0) {
                ...
                if (// If supername already is in the list
                !hs.add(supername)) {
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if (hashmap.containsKey(name_and_sig)) {
                    if (methods[i].isFinal()) {
                        ...
                        if (// static methods don't inherit
                        !methods[i].isStatic()) {
    ...
    private class CPESSC_Visitor extends org.aspectj.apache.bcel.classfile.EmptyVisitor implements Visitor {
        ...
        */
        ...
        public void visitField(Field obj) {
            ...
            } catch (ClassFormatError // sometimes BCEL is a little harsh describing exceptional situations.
            cfe) {
        ...
        public void visitMethod(Method obj) {
            ...
            {
                if (//vmspec2, p.116, 2nd paragraph
        ...
        ///////////////////////////////////////////////////////
        public //vmspec2 4.7.7
        void visitSourceFile(//vmspec2 4.7.7
        SourceFile obj) {
        ...
        //////////////////////////////////////////////////////////////
        public //vmspec2 4.7.8
        void visitLineNumberTable(//vmspec2 4.7.8
        LineNumberTable obj) {
            checkIndex(obj, obj.getNameIndex(), CONST_Utf8);
            String name = ((ConstantUtf8) cp.getConstant(obj.getNameIndex())).getBytes();
        ...
        public //vmspec2 4.7.9
        void visitLocalVariableTable(//vmspec2 4.7.9
        ...
        ////////////////////////////////////////////////////
        public //vmspec2 4.7.1
        void visitUnknown(//vmspec2 4.7.1
        Unknown obj) {
   ...
   * @see #constant_pool_entries_satisfy_static_constraints()
    ...
    private class InnerClassDetector extends EmptyVisitor {
        ...
        public void visitConstantClass(ConstantClass obj) {
            ...
            if (//Ignore the case where it's not a ConstantUtf8 here, we'll find out later.
