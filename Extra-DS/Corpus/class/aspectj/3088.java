...
public class FileUtil {
    ...
    public static int copyDir(File fromDir, File toDir, final String fromSuffix, final String toSuffix, final List collector) throws IOException {
        if (null == collector) {
    ...
    public static class Pipe implements Runnable {
        ...
        // true after completing() completes
