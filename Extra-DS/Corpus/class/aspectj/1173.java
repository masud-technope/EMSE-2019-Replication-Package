...
class BCELFactory extends EmptyVisitor {
    ...
    // Map<Instruction, InstructionHandle>
    ...
    public void visitFieldInstruction(FieldInstruction i) {
        ...
        _out.println("il.append(_factory.createFieldAccess(\"" + class_name + "\", \"" + field_name + "\", " + BCELifier.printType(type) + ", " + "Constants." + Constants.OPCODE_NAMES[opcode].toUpperCase() + "));");
    }
    ...
    public void visitInvokeInstruction(InvokeInstruction i) {
        ...
        _out.println("il.append(_factory.createInvoke(\"" + class_name + "\", \"" + method_name + "\", " + BCELifier.printType(type) + ", " + BCELifier.printArgumentTypes(arg_types) + ", " + "Constants." + Constants.OPCODE_NAMES[opcode].toUpperCase() + "));");
    }
    ...
    public void visitBranchInstruction(BranchInstruction bi) {
        ...
        if (bi instanceof Select) {
            ...
            _out.println("    BranchInstruction " + name + " = _factory.createBranchInstruction(" + "Constants." + bi.getName().toUpperCase() + ", " + target + ");");
        }
        if (bh.hasTargeters())
