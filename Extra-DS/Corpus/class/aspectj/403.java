...
public class PointcutDeclaration extends BodyDeclaration {
    ...
    public static final ChildPropertyDescriptor NAME_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(PointcutDeclaration.class, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK);

    private PointcutDesignator pointcutDesignator = null;

    public static final ChildPropertyDescriptor DESIGNATOR_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(PointcutDeclaration.class, "designator", PointcutDesignator.class, OPTIONAL, NO_CYCLE_RISK);

    /**
	 * The "parameters" structural property of this node type.
	 */
    public static final ChildListPropertyDescriptor PARAMETERS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(PointcutDeclaration.class, "parameters", SingleVariableDeclaration.class, CYCLE_RISK);
