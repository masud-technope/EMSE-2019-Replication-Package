...
public class PublicTarget {
    ...
    public void publicMethod() {
        Util.signal(Util.pubPublic);
    }

    protected void protectedMethod() {
        Util.signal(Util.pubProtected);
    }

    void defaultMethod() {
        Util.signal(Util.pubDefault);
    }

    private void privateMethod() {
        Util.signal(Util.pubPrivate);
    }
    ...
    public class PublicInner {
        ...
        /* def */
        static final int defaultStaticPublicInnerInt = 1;
        ...
        /* default */
        int defaultPublicInnerInt = 1;

        private int privatePublicInnerInt = 1;

        public void publicPublicInnerMethod() {
            Util.signal(Util.pubInnerPublic);
        }

        protected void protectedPublicInnerMethod() {
            Util.signal(Util.pubInnerProtected);
        }

        /* default */
        void defaultPublicInnerMethod() {
            Util.signal(Util.pubInnerDefault);
        }

        private void privatePublicInnerMethod() {
            Util.signal(Util.pubInnerPrivate);
        }
        ...
        public void readPublicInnerTarget() {
            ...
            PublicTarget.PublicInner publicInnerTarget = new PublicTarget().new PublicInner();
