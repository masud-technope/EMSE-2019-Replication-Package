...
public class AjASTConverter extends ASTConverter {
    ...
    public ASTNode convert(DeclareDeclaration declareDecl) {
        ...
        declareDeclaration.setSourceRange(declareDecl.declarationSourceStart, declareDecl.declarationSourceEnd - declareDecl.declarationSourceStart + 1);
    ...
    protected Comment createComment(int[] positions) {
        ...
        int end = positions[1];
        if (// Javadoc comments have positive end position
        positions[1] > 0) {
            ...
            if (// Block comment have positive start position
            positions[0] > 0) {
    ...
    protected PrimitiveType.Code getPrimitiveTypeCode(char[] name) {
        switch(name[0]) {
            ...
            case 'b':
                ...
                } else if (name.length == 7 && name[1] == 'o' && name[2] == 'o' && name[3] == 'l' && name[4] == 'e' && name[5] == 'a' && name[6] == 'n') {
    ...
    protected void setModifiers(TypeDeclaration typeDecl, org.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
        switch(this.ast.apiLevel) {
            case AST.JLS2_INTERNAL:
                ...
                modifiers &= ~IConstants.AccInterface;
