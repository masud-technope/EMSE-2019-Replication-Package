...
class StringDumper implements StringVisitor {
     ...
     */
    protected boolean preWrite(String string) throws IOException {
        return true;
    }
     ...
     * @return false if writing should abort
     */
    protected boolean postWrite(String string) throws IOException {
...
class FilteredDumper extends StringDumper {
    ...
    public  FilteredDumper(BufferedWriter writer, boolean appendNewlines, RegexpFilter filter) {
...
public class RegexpFilterReader extends BufferedReader {
     ...
     */
    public static void visitLines(BufferedReader input, StringVisitor visitor) throws IOException {
        ...
        try {
            ...
            if (openInput && (null != input)) {
                try // todo: ok to close since System.in underlies?
                {
                    input.close();
                } catch (IOException e) {
     ...
     */
    public static void write(BufferedReader input, BufferedWriter output) throws IOException {
        ...
        try {
            ...
            if (openOutput && (null != visitor)) {
                try // todo: ok to close since System.out underlies?
                {
                    visitor.close();
                } catch (IOException e) {
                    e.printStackTrace(System.err);
