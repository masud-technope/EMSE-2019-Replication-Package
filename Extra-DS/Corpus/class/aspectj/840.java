...
public class MethodDocImpl extends CodeDocImpl implements org.aspectj.ajdoc.MethodDoc {
    ...
    public ClassDoc overriddenClass() {
        ...
        while (superType != null) {
            MethodDec method = Util.methodDec(superType, methodDec().getId(), methodDec().getFormals());
            if (method != null && !method.getId().equals("not$found")) {
                if (method.getDeclaringType().equals(superType)) {
                    return null;
                }
            }
            if (superType.getTypeDec().getFullName().equals("java.lang.Object")) {
                return null;
            }
