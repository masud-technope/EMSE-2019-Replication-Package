...
public class NullIdeProperties implements ProjectPropertiesAdapter {
    ...
    public String getClasspath() {
        return testProjectPath + File.pathSeparator + System.getProperty("sun.boot.class.path") + File.pathSeparator + AjcTests.aspectjrtClasspath();
    }
    ...
    public void setInJars(Set jars) {
        this.inJars = jars;
    }

    public void setInpath(Set path) {
        this.inpath = path;
    }
    ...
    public void setOutJar(String jar) {
        this.outJar = jar;
    }
    ...
    public void setSourceRoots(Set roots) {
