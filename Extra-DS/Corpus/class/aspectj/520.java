...
public class FullyQualifiedArgumentTest extends AjdocTestCase {
    ...
    public void testPr58520() throws Exception {
        ...
        File[] files = { new File(getAbsoluteProjectDir() + File.separatorChar + "src/pack/C.java"), new File(getAbsoluteProjectDir() + File.separatorChar + "src/pack/A.aj") };
        ...
        String[] stringsA = { "C.html#method3(java.lang.String)", "C.html#method3(String)" };
        List missing = AjdocOutputChecker.getMissingStringsInSection(htmlA, stringsA, "ADVICE SUMMARY");
        assertEquals("There should be one missing string", 1, missing.size());
        assertEquals("The fully qualified name should appear in the argument", "C.html#method3(String)", missing.get(0));
    }
}
