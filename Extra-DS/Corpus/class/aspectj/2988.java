...
public class GeneratingAnnotatedClassesTest extends BcelTestCase {
    ...
    public void testGenerateClassLevelAnnotations() throws ClassNotFoundException {
        ...
        Annotation one = as[0];
        Annotation two = as[1];
        assertTrue("Name of annotation 1 should be SimpleAnnotation but it is " + as[0].getTypeName(), as[0].getTypeName().equals("SimpleAnnotation"));
        assertTrue("Name of annotation 2 should be SimpleAnnotation but it is " + as[1].getTypeName(), as[1].getTypeName().equals("SimpleAnnotation"));
    ...
    public void testGenerateMethodLevelAnnotations2() throws ClassNotFoundException {
        ...
        assertTrue("The 'Method' should have one annotations but has " + mainMethod1.getAnnotations().length, mainMethod1.getAnnotations().length == 1);
        MethodGen mainMethod2 = new MethodGen(mainMethod1, cg2.getClassName(), cg2.getConstantPool());
        assertTrue("The 'MethodGen' should have one annotations but has " + mainMethod2.getAnnotations().length, mainMethod2.getAnnotations().length == 1);
    ...
    public void testTransformClassToClassGen_ArrayAndAnnotationTypes() throws ClassNotFoundException {
        ...
        assertTrue("Should be called LSimpleAnnotation; but is called: " + innerAnnotationValue.getAnnotation().getTypeName(), innerAnnotationValue.getAnnotation().getTypeSignature().equals("LSimpleAnnotation;"));
    }
