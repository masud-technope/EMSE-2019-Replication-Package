...
public class AsmRelationshipsTest extends AjdeTestCase {
    ...
    public void testUsesPointcut() {
        ...
        assertNotNull(pts);
        IProgramElement pUsesA = manager.getHierarchy().findElementForLabel(ptUsage, IProgramElement.Kind.POINTCUT, /*Point"*/
        "usesA()");
        assertNotNull(pUsesA);
        IProgramElement ptsA = manager.getHierarchy().findElementForLabel(pts, IProgramElement.Kind.POINTCUT, /*Point"*/
        "a()");
        assertNotNull(ptsA);
    ...
    public void testDeclareParents() {
        ...
        IProgramElement dp = manager.getHierarchy().findElementForLabel(aspect, IProgramElement.Kind.DECLARE_PARENTS, "declare parents: implements Serializable");
        assertNotNull(dp);
        /*List relations = */
        manager.getRelationshipMap().get(dp);
    ...
    public void testDeclareWarningAndError() {
        checkDeclareMapping("DeclareCoverage", "Point", "declare warning: \"Illegal call.\"", "method-call(void Point.setX(int))", "matched by", "matches declare", IProgramElement.Kind.DECLARE_WARNING);
    }
    ...
    private void checkDeclareMapping(String fromType, String toType, String from, String to, String forwardRelName, String backRelName, IProgramElement.Kind kind) {
    ...
    private void checkInterTypeMapping(String fromType, String toType, String from, String to, String forwardRelName, String backRelName, IProgramElement.Kind declareKind) {
        IProgramElement aspect = AsmManager.getDefault().getHierarchy().findElementForType(null, fromType);
        assertNotNull(aspect);
        String beforeExec = from;
