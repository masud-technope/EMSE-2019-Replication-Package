...
public class BuildArgParser extends Main {
    ...
    public void printVersion() {
        //$NON-NLS-1$
        System.err.println("AspectJ Compiler " + Version.text + " built on " + Version.time_text);
        System.err.flush();
    }

    public void printUsage() {
        //$NON-NLS-1$
        System.out.println(bind("misc.usage"));
        System.out.flush();
    }
