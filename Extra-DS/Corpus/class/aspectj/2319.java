...
public class LocalsFromInnerCP {
    ...
    static {
        ...
        new Runnable() {
            ...
            public void run() {
                signal("LocalsFromInnerCP.<clinit>.Runnable.run()", i);
            }
        }.run();
    }
        ...
        class m {
            ...
            void f() {
                new Runnable() {
                    ...
                    public void run() {
                        signal("LocalsFromInnerCP.m(int).m.f().Runnable.run()", i);
                    }
                }.run();
            }
        }
        ...
        class m {
            ...
            void f() {
                new Runnable() {
                    ...
                    public void run() {
                        signal("LocalsFromInnerCP.m().m.f().Runnable.run()", i);
                    }
                }.run();
            }
        }
    ...
    class m {
        ...
        void f() {
            ...
            new Runnable() {
                ...
                public void run() {
                    signal("LocalsFromInnerCP.m.f().Runnable.run()", i);
                }
            }.run();
        }
        ...
        void f(final int i) {
            new Runnable() {
                ...
                public void run() {
                    signal("LocalsFromInnerCP.m.f(int).Runnable.run()", i);
                }
            }.run();
        }
    }
     ...
     LocalsFromInnerCP() {
        ...
        new Runnable() {
            ...
            public void run() {
                signal("LocalsFromInnerCP.LocalsFromInnerCP().Runnable.run()", i);
            }
        }.run();
    }
     ...
     LocalsFromInnerCP(final int i) {
        new Runnable() {
            ...
            public void run() {
                signal("LocalsFromInnerCP.LocalsFromInnerCP(int).Runnable.run()", i);
            }
        }.run();
    }
