...
public class CompilerMessagesTest extends AjdeTestCase {
    ...
    public void testMessages() {
        ...
        NullIdeTaskListManager.SourceLineTask task = (NullIdeTaskListManager.SourceLineTask) msgs.get(0);
        ...
        try {
            ...
            fullyQualifiedFile = fullyQualifiedFile.replace('\\', '/');
            assertTrue("Fully-qualified source file location returned", fullyQualifiedFile.endsWith("/examples/declare-warning/apackage/SomeClass.java"));
