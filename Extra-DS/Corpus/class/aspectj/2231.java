...
public class DeclareParents extends AjcTestCase {
    ...
    public void testSimpleDeclareParents() {
        File testBase = new File(baseDir, "TestA");
        runSourceAndBinaryTestcase(testBase, new String[] { "Top1.java", "Middle1.java", "Bottom1.java" }, new String[] { "AspectX1.java" }, false);
    //      runClass("Bottom1");
    }
    ...
    public void test_SuperCtorCall() {
        File testBase = new File(baseDir, "TestA");
        runSourceAndBinaryTestcase(testBase, new String[] { "Top2.java", "Middle2.java", "Bottom2.java" }, new String[] { "AspectX2.java" }, false);
    //      runClass("Bottom2");
    }
    ...
    public void test_SuperMethodCall() {
        File testBase = new File(baseDir, "TestA");
        runSourceAndBinaryTestcase(testBase, new String[] { "Top3.java", "Middle3.java", "Bottom3.java" }, new String[] { "AspectX3.java" }, false);
    //        runClass("Bottom3");
    }
    ...
    public void test_missingCtorInIntroducedClass() {
        File testBase = new File(baseDir, "TestA");
        runSourceAndBinaryTestcase(testBase, new String[] { "Top4.java", "Middle4.java", "Bottom4.java" }, new String[] { "AspectX4.java" }, true, false);
    }
    ...
    public void test_cantMakeInheritedInstanceMethodsStatic() {
        ...
        runSourceAndBinaryTestcase(new File(baseDir, "TestC"), new String[] { "A1.java", "B1.java" }, new String[] { "X1.java" }, true, false);
    }
    ...
    public void xxxtest_cantExtendFinalClass() {
        ...
        File testBase = new File(baseDir, "TestC");
        CompilationResult result = null;
        runSourceAndBinaryTestcase(new File(baseDir, "TestC"), new String[] { "A2.java", "B2.java" }, new String[] { "X2.java" }, true, true);
    }
    ...
    public void test_cantReduceVisibilityOfOverriddenMethods_1() {
        ...
        CompilationResult result = null;
        runSourceAndBinaryTestcase(new File(baseDir, "TestB"), new String[] { "Top1.java", "Middle1.java" }, new String[] { "Aspect1.java" }, true, false);
    }
    ...
    public void test_cantReduceVisibilityOfOverriddenMethods_2() {
        File testBase = new File(baseDir, "TestB");
        CompilationResult result = null;
        runSourceAndBinaryTestcase(new File(baseDir, "TestB"), new String[] { "TopTop6.java", "Top6.java", "Middle6.java" }, new String[] { "Aspect6.java" }, true, false);
    }
    ...
    public void test_overriddenMethodsCantHaveIncompatibleReturnTypes() {
        File testBase = new File(baseDir, "TestB");
        CompilationResult result = null;
        runSourceAndBinaryTestcase(new File(baseDir, "TestB"), new String[] { "Top2.java", "Middle2.java", "Super.java", "Sub.java" }, new String[] { "Aspect2.java" }, true);
    }
    ...
    public void test_inheritedAbstractMethodsMustBeImplemented_1() {
        File testBase = new File(baseDir, "TestB");
        CompilationResult result = null;
        runSourceAndBinaryTestcase(new File(baseDir, "TestB"), new String[] { "Top3.java", "Middle3.java", "Super.java", "Sub.java" }, new String[] { "Aspect3.java" }, true);
    }
    ...
    public void test_interfaceMethodsImplemented() {
        ...
        CompilationResult result = null;
        runSourceAndBinaryTestcase(testBase, new String[] { "SimpleClass1.java", "SimpleIntf1.java" }, new String[] { "SimpleAspect1.java" }, true);
    }
    ...
    public void test_inheritedAbstractMethodsMustBeImplemented_2() {
        File testBase = new File(baseDir, "TestB");
        CompilationResult result = null;
        runSourceAndBinaryTestcase(new File(baseDir, "TestB"), new String[] { "TopTop4.java", "Top4.java", "Middle4.java" }, new String[] { "Aspect4.java" }, true);
    }
    ...
    public void test_inheritedAbstractMethodsMustBeImplemented_3() {
        File testBase = new File(baseDir, "TestD");
        CompilationResult result = null;
        runSourceAndBinaryTestcase(new File(baseDir, "TestD"), new String[] { "SimpleClass2.java" }, new String[] { "SimpleAspect2.java" }, true);
    }
    ...
    public void runSourceAndBinaryTestcase(File testBase, String[] classes, String[] aspects, boolean expectErrors, boolean compareErrors) {
        ...
        assertTrue("Should have same number of errors in either case: " + sourceErrorMessagesCount + "!=" + binaryErrorMessagesCount, sourceErrorMessagesCount == binaryErrorMessagesCount);
