...
public class SoftMessage implements IMessage {
    ...
    public static void writeXml(XMLWriter out, IMessageHolder messages) {
        if ((null == out) || (null == messages) || (0 == messages.numMessages(null, true))) {
            return;
        }
	 ...
	 */
    public static void writeXml(XMLWriter out, // XXX short form only, no files
    IMessage message) {
	 ...
	 * and thrown is null.
	 */
    public  SoftMessage(String message, IMessage.Kind kind, Throwable thrown, ISourceLocation sourceLocation) {
    ...
    public final ISourceLocation getSourceLocation() {
        if ((null == sourceLocation) && ((null != file) || (line != Integer.MAX_VALUE))) {
