...
public class SingleIndexWriter extends com.sun.tools.doclets.standard.SingleIndexWriter {
    ...
    public static void generate(IndexBuilder indexbuilder) throws DocletAbortException {
        ...
        try {
            (sw = new SingleIndexWriter(filename, indexbuilder)).generateIndexFile();
        } catch (IOException e) {
            Standard.configuration().standardmessage.error("doclet.exception_encountered", e + "", filename);
