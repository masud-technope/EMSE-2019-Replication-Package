...
public class PatternParser {
    ...
    public PerClause maybeParsePerClause() {
        ...
        if (tok.isIdentifier()) {
            ...
            } else if (// PTWIMPL Parse the pertypewithin clause
            name.equals("pertypewithin")) {
    ...
    public Declare parseDeclare() {
        ...
        if (kind.equals("error")) {
            ...
            throw new ParserException("expected one of error, warning, parents, soft, precedence, @type, @method, @constructor, @field", tokenSource.peek(-1));
        }
    ...
    private TypePattern setAnnotationPatternForTypePattern(TypePattern t, AnnotationTypePattern ap) {
        ...
        if (ap != AnnotationTypePattern.ANY) {
            ...
            if (t.annotationPattern == AnnotationTypePattern.ANY) {
                ...
                ret.setAnnotationTypePattern(new AndAnnotationTypePattern(ap, //???
                t.annotationPattern));
            }
        }
        return ret;
    ...
    public AnnotationTypePattern maybeParseSingleAnnotationPattern() {
        ...
        if (maybeEat("!")) {
            if (maybeEat("@")) {
                ...
                // not for us!
                tokenSource.setIndex(startIndex);
                return ret;
            }
        }
        if (maybeEat("@")) {
    ...
    public TypeVariablePattern parseTypeVariable() {
        ...
        if (typeVariableName == null)
            typeVariableName = parseIdentifier();
        if (maybeEatIdentifier("extends")) {
