...
public class WeavingURLClassLoaderTest extends TestCase {
    ...
    private static final String CLASSES_JAR = BcweaverTests.TESTDATA_PATH + "/ltw-classes.jar";

    private static final String WOVEN_JAR = BcweaverTests.TESTDATA_PATH + "/ltw-woven.jar";

    private static final String JUNK_JAR = BcweaverTests.TESTDATA_PATH + "/ltw-junk.jar";

    private static final String ADVICE_ASPECTS = BcweaverTests.TESTDATA_PATH + "/ltw-aspects.jar";

    private static final String DW_ADVICE_ASPECTS = BcweaverTests.TESTDATA_PATH + "/ltw-dwaspects.jar";

    private static final String DE_ADVICE_ASPECTS = BcweaverTests.TESTDATA_PATH + "/ltw-deaspects.jar";

    private static final String AROUNDCLOSURE_ASPECTS = BcweaverTests.TESTDATA_PATH + "/ltw-acaspects.jar";

    private static final String ITD_ASPECTS = BcweaverTests.TESTDATA_PATH + "/ltw-itdaspects.jar";

    private static final String PER_ASPECTS = BcweaverTests.TESTDATA_PATH + "/ltw-peraspects.jar";

    private static final String TEST_BASE = BcweaverTests.TESTDATA_PATH + "/WeavingURLClassLoaderTest/builtLibs";
