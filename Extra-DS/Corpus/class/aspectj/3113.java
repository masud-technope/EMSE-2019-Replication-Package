...
public class GenericITDsDesign extends XMLBasedAjcTestCase {
    ...
    public List getTypeMunger(/*BcelTypeMunger*/
    String classname) {
        ClassPath cp = new ClassPath(ajc.getSandboxDirectory() + File.pathSeparator + System.getProperty("java.class.path"));
	...
	*/
    ...
    public void testDesignA() {
        ...
        theMember.resolve(recentWorld);
        tVar = theMember.getTypeVariables()[0];
        tvrt = (TypeVariableReference) theMember.getParameterTypes()[0];
        assertTrue("Post resolution, the type variable in the parameter should be identical to the type variable declared on the member", tVar == tvrt.getTypeVariable());
    }
    ...
    public void testDesignF() {
        ...
        assertTrue("Field list1 should be of type 'Ljava/util/List;' but is " + list1.getSignature(), list1.getSignature().equals("Ljava/util/List;"));
        Field list2 = (Field) fields.get("ajc$interField$$list1");
        assertTrue("Field list2 should be of type 'Ljava/util/List;' but is " + list2.getSignature(), list2.getSignature().equals("Ljava/util/List;"));
        ...
        assertTrue("Field list1 should be of type 'Ljava/lang/String;' but is " + field1.getSignature(), field1.getSignature().equals("Ljava/lang/String;"));
        Field field2 = (Field) fields.get("ajc$interField$$field2");
        assertTrue("Field list2 should be of type 'Ljava/lang/Object;' but is " + field2.getSignature(), field2.getSignature().equals("Ljava/lang/Object;"));
    }
