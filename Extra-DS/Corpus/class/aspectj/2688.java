...
public class DeclareAtFieldDeclaration extends DeclareAnnotationDeclaration {
    ...
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = internalJavadocPropertyFactory(DeclareAtFieldDeclaration.class);

    public static final ChildPropertyDescriptor PATTERN_PROPERTY = internalPatternNodePropertyFactory(DeclareAtFieldDeclaration.class);

    public static final ChildPropertyDescriptor ANNOTATION_NAME_PROPERTY = internalAnnotationNamePropertyFactory(DeclareAtFieldDeclaration.class);
