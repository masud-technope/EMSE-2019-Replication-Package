...
public class NamePattern extends PatternNode {
    ...
    private static boolean outOfStar(final char[] pattern, final char[] target, int pi, int ti, int pLeft, int tLeft, final int starsLeft) {
        if (pLeft > tLeft)
            return false;
        while (true) {
    ...
    private static boolean inStar(final char[] pattern, final char[] target, int pi, int ti, final int pLeft, int tLeft, int starsLeft) {
