...
public class TypeVariableTestCase extends TestCase {
    ...
    public void testResolution() {
        TypeVariable tv = new TypeVariable("T", javaLangNumber, new UnresolvedType[] { javaUtilList }, javaLangDouble);
        tv.resolve(world);
        assertEquals("resolved number", javaLangNumber.resolve(world), tv.getUpperBound());
        assertEquals("resolved list", javaUtilList.resolve(world), tv.getAdditionalInterfaceBounds()[0]);
