...
public class ClassPath implements Serializable {
   ...
   */
    public  ClassPath(String class_path) {
        ...
        for (StringTokenizer tok = new StringTokenizer(class_path, System.getProperty("path.separator")); tok.hasMoreTokens(); ) {
   ...
   */
    public static final String getClassPath() {
        ...
        for (Iterator e = dirs.iterator(); e.hasNext(); ) {
            ...
            if (extensions != null)
                for (int i = 0; i < extensions.length; i++) list.add(ext_path + File.separatorChar + extensions[i]);
        }
