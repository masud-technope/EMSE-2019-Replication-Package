...
public class Validator {
    ...
    // deleteTempFiles requires ListIterator.remove()
    ...
    public boolean nullcheck(Object[] ra, String message) {
        return ((nullcheck((Object) ra, message + " array")) && nullcheck(Arrays.asList(ra), message));
    }
    ...
    public boolean canRead(File baseDir, String[] paths, String message) {
        if (!canRead(baseDir, "baseDir - " + message) || !nullcheck(paths, "paths - " + message)) {
            return false;
        }
    ...
    public boolean canReadFiles(Object[] dirs, String message) {
        return ((nullcheck((Object) dirs, message + " dir array")) && canReadFiles(Arrays.asList(dirs), message));
    }
    ...
    public boolean canReadDirs(Object[] dirs, String message) {
        return ((nullcheck((Object) dirs, message + " dir array")) && canReadDirs(Arrays.asList(dirs), message));
    }
    ...
    public boolean canWriteFiles(Object[] dirs, String message) {
        return ((nullcheck((Object) dirs, message + " dir array")) && canWriteFiles(Arrays.asList(dirs), message));
    }
    ...
    public boolean canWriteDirs(Object[] dirs, String message) {
        return ((nullcheck((Object) dirs, message + " dir array")) && canWriteDirs(Arrays.asList(dirs), message));
    }
    ...
    */
     ...
     */
    public File getWritableDir(File dir, String name, boolean deleteContents, boolean register, String failMessage) {
        // check dir
        if (null == dir) {
            if (null == name) {
                name = "Validator";
