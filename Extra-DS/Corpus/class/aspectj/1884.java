...
public class MethodSubWriter extends ExecutableMemberSubWriter {
    ...
    public static class Del extends com.sun.tools.doclets.standard.MethodSubWriter {
        ...
        public void setDelegator(MethodSubWriter mw) {
            this.mw = mw;
        }
    ...
    public  MethodSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc classdoc) {
        super(writer, classdoc);
    }

    public  MethodSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }
