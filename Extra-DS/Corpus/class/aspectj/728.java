...
public class PointcutSubWriter extends AbstractSubWriter {
    ...
    public  PointcutSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer, ClassDoc classdoc) {
        super(writer, classdoc);
    }

    public  PointcutSubWriter(com.sun.tools.doclets.standard.SubWriterHolderWriter writer) {
        super(writer);
    }
    ...
    protected void printDeprecatedLink(ProgramElementDoc member) {
        writer.printClassLink(member.containingClass(), member.name(), ((PointcutDoc) member).qualifiedName());
    }
    ...
    protected void printOverridden(ClassDoc overridden, PointcutDoc pcd) {
        if (overridden != null) {
            ...
            writer.dd();
            writer.printText("doclet.in_class", writer.codeText(writer.getClassLink(overridden, name + pcd.signature(), name, false)), writer.codeText(writer.getClassLink(overridden)));
        }
    }
    ...
    protected void printTags(ProgramElementDoc member) {
        ...
        if (params.length + returnsTag.length + sinces.length + sees.length > 0) {
            writer.dd();
            writer.dl();
