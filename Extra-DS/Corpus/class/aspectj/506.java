...
public class AjdtCommandTestCase extends TestCase {
    ...
    public void testIncrementalOption() throws InvalidInputException {
        ...
        assertTrue("specified a file", outputWriter.getContents().indexOf("incremental mode only handles source files using -sourceroots") != -1);
        ;
    }
    ...
    public void testBadOptionAndUsagePrinting() throws InvalidInputException {
        ...
        assertTrue(outputWriter.getContents() + " contains? " + "Usage", outputWriter.getContents().indexOf("-mubleBadOption") != -1);
    }
    ...
    public void testVersionOutput() throws InvalidInputException {
        ...
        String text = byteArrayOut.toString();
        assertTrue("version output", text.indexOf("AspectJ Compiler") != -1);
    }
