...
public class JavadocComparePackageMode {
    ...
    public static void test() {
        ...
        Vector diffs2 = null;
        try {
            diffs1 = outputComparator.compareFilesByLine(AJDOC_DIR + "/" + FILE_1, JAVADOC_DIR + "/" + FILE_1);
            diffs2 = outputComparator.compareFilesByLine(AJDOC_DIR + "/" + FILE_1, JAVADOC_DIR + "/" + FILE_1);
        ...
        String result2 = "";
        if (diffs1 != null)
            result1 = diffs1.toString();
        if (diffs2 != null)
            result2 = diffs2.toString();
