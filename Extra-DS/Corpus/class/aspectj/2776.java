...
public class IncrementalTests extends org.aspectj.testing.XMLBasedAjcTestCase {
   ...
   */
    ...
    public void test009() throws Exception {
        ...
        run("packageOne.Main", new String[] { "in longer packageOne.Main.main(..)", "before main packageOne.Main" }, null);
    }
    ...
    public void test011() throws Exception {
        ...
        nextIncrement(false);
        assertTrue("AdviceOnIntroduced$AjcClosure1.class exists", new File(ajc.getSandboxDirectory(), "AdviceOnIntroduced$AjcClosure1.class").exists());
