...
public class AppContainerTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        URLClassLoader app1CL = new URLClassLoader(new URL[] { new URL(path1) }, AppContainerTest.class.getClassLoader());
        URLClassLoader app2CL = new URLClassLoader(new URL[] { new URL(path2) }, AppContainerTest.class.getClassLoader());
