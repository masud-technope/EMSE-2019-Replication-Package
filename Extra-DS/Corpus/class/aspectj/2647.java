...
public class PerTypeWithin extends PerClause {
    ...
    protected Test findResidueInternal(Shadow shadow, ExposedState state) {
        ...
        Expr myInstance = Expr.makeCallExpr(AjcMemberMaker.perTypeWithinLocalAspectOf(shadow.getEnclosingType(), inAspect), Expr.NONE, inAspect);
    ...
    public PerClause concretize(ResolvedType inAspect) {
        ...
        SignaturePattern sigpat = new SignaturePattern(Member.STATIC_INITIALIZATION, ModifiersPattern.ANY, TypePattern.ANY, //typePattern,
        TypePattern.ANY, NamePattern.ANY, TypePatternList.ANY, ThrowsPattern.ANY, AnnotationTypePattern.ANY);
    ...
    public boolean equals(Object other) {
        ...
        return ((pc.inAspect == null) ? (inAspect == null) : pc.inAspect.equals(inAspect)) && ((pc.typePattern == null) ? (typePattern == null) : pc.typePattern.equals(typePattern));
    }
