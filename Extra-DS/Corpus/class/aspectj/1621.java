...
public class AfterThrowingAdviceDeclaration extends AfterAdviceDeclaration {
    ...
    public static final ChildListPropertyDescriptor throwingPARAMETERS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AfterThrowingAdviceDeclaration.class, "parameters", SingleVariableDeclaration.class, CYCLE_RISK);

    public static final ChildPropertyDescriptor throwingPOINTCUT_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AfterThrowingAdviceDeclaration.class, "pointcut", PointcutDesignator.class, MANDATORY, NO_CYCLE_RISK);

    public static final ChildListPropertyDescriptor throwingTHROWN_EXCEPTIONS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AfterThrowingAdviceDeclaration.class, "thrownExceptions", Name.class, NO_CYCLE_RISK);

    public static final ChildPropertyDescriptor throwingBODY_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AfterThrowingAdviceDeclaration.class, "body", Block.class, OPTIONAL, CYCLE_RISK);

    protected static List throwingPROPERTY_DESCRIPTORS_2_0;

    protected static List throwingPROPERTY_DESCRIPTORS_3_0;

    public static final ChildPropertyDescriptor throwingTHROWING_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(AfterThrowingAdviceDeclaration.class, "throwing", SingleVariableDeclaration.class, OPTIONAL, NO_CYCLE_RISK);
    ...
    int treeSize() {
        return super.treeSize() + (this.throwing == null ? 0 : this.throwing.treeSize());
    }
