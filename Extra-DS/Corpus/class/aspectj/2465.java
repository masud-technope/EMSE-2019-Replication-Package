...
public class BcelTestCase extends TestCase {
    ...
    protected boolean wipe(String dir, String name) {
        ...
        if (files == null || files.length == 0) {
            // Why does this not succeed? stupid thing
            new File(dir).delete();
        }
        return b;
    }
    ...
    public SyntheticRepository createRepos(String cpentry) {
        ClassPath cp = new ClassPath("testdata" + File.separator + cpentry + File.pathSeparator + System.getProperty("java.class.path"));
