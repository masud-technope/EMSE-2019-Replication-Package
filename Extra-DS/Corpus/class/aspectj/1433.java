...
public class Structure {
    ...
    protected static final GenericTreeNodeListOrdererFactoryI STRING_SORTER_FACTORY = new StringSortFactory();

    /** singleton factory to sort by string */
    protected static final GenericTreeNodeListOrdererI STRING_SORTER = new StringSort();
    ...
    public static final String[] DEFAULT_ARGS = new String[] { "-d", "classes", "-workingdir", "ajworkingdir", "-argfile", DEFAULT_LST };
        ...
        while (readIndex < args.length) {
            ...
            if ((null == arg) || (0 == arg.length())) {
                ...
                if ("-toOut".equals(arg)) {
                    ...
                    readIndex++;
                    String next = ((readIndex < args.length) ? args[readIndex] : null);
                    boolean nextIsOption = ((null != next) && next.startsWith("-"));
                    ...
                    if ((calleeArg == SKIP) && ((null == next) || (nextIsOption))) {
    ...
    static class StringSortFactory implements GenericTreeNodeListOrdererFactoryI {
         ...
         */
        public GenericTreeNodeListOrdererI produce(GenericTreeNode lhs, GenericTreeNode rhs, GenericTreeNodesVisitorI visitor) {
    ...
    static class StringSort implements GenericTreeNodeListOrdererI {
        ...
        public List[] produceLists(List lhs, List rhs) {
            if (null != lhs)
                Collections.sort(lhs, STRING_COMP);
            if (null != rhs)
                Collections.sort(rhs, STRING_COMP);
    ...
    static class StringComparator implements Comparator {
        ...
        public int compare(Object lhs, Object rhs) {
            if (null == lhs) {
                ...
                return 1;
            } else if ((lhs instanceof GenericTreeNode) && (rhs instanceof GenericTreeNode)) {
