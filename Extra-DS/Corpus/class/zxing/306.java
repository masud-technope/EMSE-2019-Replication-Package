...
public class CalendarEventGenerator implements GeneratorSource {
    ...
    public static final String[] FULL_DAY_ONLY_IDS = { "fullDayOnlyInfo1", "fullDayOnlyInfo2", "fullDayOnlyInfo3", "fullDayOnlyInfo4" };
    ...
    TimePicker timePicker1 = new TimePicker(new Date(), DateTimeFormat.getFormat("a"), DateTimeFormat.getFormat("hh"), DateTimeFormat.getFormat("mm"), null);

    TimePicker timePicker2 = new TimePicker(new Date(), DateTimeFormat.getFormat("a"), DateTimeFormat.getFormat("hh"), DateTimeFormat.getFormat("mm"), null);
    ...
    public  CalendarEventGenerator(final ChangeListener listener, KeyPressHandler keyListener) {
