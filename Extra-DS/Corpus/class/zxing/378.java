...
public final class ParsedReaderResultTestCase extends TestCase {
   ...
   */
    ...
    private static void doTestResult(String contents, String goldenResult, ParsedResultType type, BarcodeFormat format) {
