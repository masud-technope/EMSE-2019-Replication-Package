...
public class BcelRenderer implements ITestVisitor, IExprVisitor {
     ...
     * @returns the instruction list representing this expression
     */
    public static InstructionList renderTest(InstructionFactory fact, BcelWorld world, Test e, InstructionHandle sk, InstructionHandle fk) {
    ...
    public void visit(HasAnnotation hasAnnotation) {
        ...
        Member isAnnotationPresent = MemberImpl.method(UnresolvedType.forName("java/lang/Class"), 0, "isAnnotationPresent", "(Ljava/lang/Class;)Z");
