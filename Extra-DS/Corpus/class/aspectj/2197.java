...
public class AroundArgsWeaveTestCase extends WeaveTestCase {
    ...
    public void testWeave() throws IOException {
        ...
        ShadowMunger p = makeConcreteAdvice("around(list) : " + "(call(public * add(..)) && target(list)) -> " + "static boolean Aspect.ajc_around0" + "(java.util.ArrayList, org.aspectj.runtime.internal.AroundClosure)");
