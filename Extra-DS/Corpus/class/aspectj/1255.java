...
class PureJava extends TargetClass {
    ...
    public class inner {
        ...
        public void run() {
            // s.b. PureJava
            InnerClass j = TargetClass.this.new InnerClass();
            // s.b. PureJava
            boolean boolean_4 = TargetClass.this.getboolean();
        }
    }

    // s.b. PureJava
    boolean result_cast = TargetClass.this.getboolean();

    // s.b. PureJava
    InnerClass f = TargetClass.this.new InnerClass();
}
