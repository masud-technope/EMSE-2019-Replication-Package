                    ...
                    if (relations != null) {
                        for (Iterator it = relations.iterator(); it.hasNext(); ) {
                            ...
                            if (relationship.getKind().equals(IRelationship.Kind.ADVICE)) {
                                System.out.println("method: " + node.toString() + ", advised by: " + relationship.getTargets());
                            }
                        }
                    }
                }
                    ...
                    if (relations != null) {
                        for (Iterator it = relations.iterator(); it.hasNext(); ) {
                            ...
                            if (relationship.getKind().equals(IRelationship.Kind.DECLARE_INTER_TYPE)) {
                                System.out.println("file: " + node.getSourceLocation().getSourceFile().getName() + ", declared on by: " + relationship.getTargets());
                            }
                        }
                    }
                }
