...
public class InvocationJoinPointClosureTest extends TestCase {
    ...
    public void testGetStaticPartMethod() {
        MockMethodSignature sig = new MockMethodSignature("toString", Object.class, new Class[] {});
        ...
        try {
            assertEquals("Should find toString method", Object.class.getMethod("toString", new Class[] {}), ao);
    ...
    public void testGetStaticPartConstructor() {
        MockConstructorSignature sig = new MockConstructorSignature("new", StringBuffer.class, new Class[] { String.class });
        MockJoinPoint jp = new MockJoinPoint(this, sig, null);
        InvocationJoinPointClosure mejpc = new InvocationJoinPointClosure(jp) {
        ...
        AccessibleObject ao = mejpc.getStaticPart();
        try {
            assertEquals("Should find StringBuffer constructor", StringBuffer.class.getConstructor(new Class[] { String.class }), ao);
        } catch (NoSuchMethodException e) {
            fail("Duff test:" + e);
        }
    }
    ...
    public void testGetStaticPartException() {
        try {
            MockMethodSignature sig = new MockMethodSignature("toKettle", Object.class, new Class[] {});
            MockJoinPoint jp = new MockJoinPoint(this, sig, null);
            InvocationJoinPointClosure mejpc = new InvocationJoinPointClosure(jp) {
