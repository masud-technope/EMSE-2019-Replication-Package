...
public class AjTypeDeclaration extends TypeDeclaration {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor ASPECT_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(TypeDeclaration.class, "aspect", boolean.class, MANDATORY);
