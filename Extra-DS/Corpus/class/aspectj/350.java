...
public class ReferenceType extends ResolvedType {
    ...
    public final boolean isAssignableFrom(ResolvedType other, boolean allowMissing) {
        ...
        if (this.isGenericType() && other.isRawType()) {
            if (isAssignableFrom((ResolvedType) other.getGenericType()))
                return true;
        }
    ...
    public ResolvedMember[] getDeclaredFields() {
        ...
        if (isParameterizedType() || isRawType()) {
            ...
            for (int i = 0; i < delegateFields.length; i++) {
                parameterizedFields[i] = delegateFields[i].parameterizedWith(getTypesForMemberParameterization(), this, isParameterizedType());
            }
            return parameterizedFields;
        } else {
    ...
    public PerClause getPerClause() {
        ...
        if (// could cache the result here...
        isParameterizedType()) {
    ...
    public void setDelegate(ReferenceTypeDelegate delegate) {
        ...
        if (isRawType() && getGenericType() != null) {
            ...
            if (// avoids circular updates
            genType.getDelegate() != delegate) {
