...
public class IntroducedSuperDocImpl extends IntroductionDocImpl implements IntroducedSuperDoc {
    ...
    public  IntroducedSuperDocImpl(com.sun.javadoc.ClassDoc containingClass, IntroducedSuperDec introducedSuperDec) {
    ...
    public org.aspectj.ajdoc.Type[] types() {
        return (org.aspectj.ajdoc.Type[]) types.toArray(new org.aspectj.ajdoc.Type[types.size()]);
    }
    ...
    public String name() {
        ...
        if (true)
            return "";
        return (introducedSuperDec.getTypeDs().size() != 0) ? ((org.aspectj.ajdoc.Type) introducedSuperDec.getTypeDs().get(0).getType()).typeName() : "";
