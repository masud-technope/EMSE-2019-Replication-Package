 ...
 */
public class ClassDocImpl extends ProgramElementDocImpl implements org.aspectj.ajdoc.ClassDoc {
    ...
    protected  ClassDocImpl(com.sun.javadoc.ClassDoc containingClass, TypeDec typeDec) {
        ...
        createImports(importedClasses = new ArrayList(), importedPackages = new ArrayList());
    }
    ...
    public TypeDec nonNullTypeDec() {
        if (typeDec().getLexicalType() == null)
            return typeDec();
    ...
    private Collection createInnerTypes() {
        ...
        FilteredDecList result = new FilteredDecList(getFilter(), this);
        if (items != null) {
     ...
     */
    private void createImports(final Collection importClasses, final Collection importPkgs) {
        ...
        if (cu != null) {
            ...
            if (imports != null) {
                for (int i = 0; i < imports.size(); i++) {
                    ...
                    if (imprt != null) {
                        if (imprt.getStar()) {
                            PackageDoc importedPkg = PackageDocImpl.getPackageDoc(imprt.getName());
                            if (importedPkg != null) {
                                importPkgs.add(importedPkg);
                            }
                        } else {
                            com.sun.javadoc.ClassDoc importedClass = findClass(imprt.getName());
    ...
    public com.sun.javadoc.ClassDoc findClass(String classname) {
        ...
        if (classname.equals(name()) || classname.equals(qualifiedName())) {
            return this;
        }
    ...
    public FieldDoc[] fields() {
        ...
        return (FieldDoc[]) fieldDocs.toArray(new org.aspectj.ajdoc.FieldDoc[fieldDocs.size()]);
    }
    ...
    public boolean isSerializable() {
        for (Iterator i = typeDec().getSuperInterfaceTypes().iterator(); i.hasNext(); ) {
    ...
    public MethodDoc[] methods() {
        ...
        return (MethodDoc[]) methodDocs.toArray(new org.aspectj.ajdoc.MethodDoc[methodDocs.size()]);
    }
    ...
    public com.sun.javadoc.ClassDoc[] interfaces() {
        ...
        return (ClassDoc[]) interfaceDocs.toArray(new org.aspectj.ajdoc.ClassDoc[interfaceDocs.size()]);
    }
    ...
    public ConstructorDoc[] constructors() {
        ...
        return (ConstructorDoc[]) constructorDocs.toArray(new org.aspectj.ajdoc.ConstructorDoc[constructorDocs.size()]);
    }
    ...
    public com.sun.javadoc.ClassDoc[] innerClasses() {
        ...
        return (ClassDoc[]) innerclassDocs.toArray(new org.aspectj.ajdoc.ClassDoc[size]);
    }
    ...
    public com.sun.javadoc.ClassDoc[] importedClasses() {
        return (ClassDoc[]) importedClasses.toArray(new org.aspectj.ajdoc.ClassDoc[importedClasses.size()]);
    }
    ...
    public PackageDoc[] importedPackages() {
        return (PackageDoc[]) importedPackages.toArray(new org.aspectj.ajdoc.PackageDoc[importedPackages.size()]);
    }
    ...
    public PointcutDoc[] pointcuts() {
        ...
        return (PointcutDoc[]) pointcutDocs.toArray(new PointcutDoc[pointcutDocs.size()]);
    }
    ...
    public boolean isException() {
        //TODO: make lazy
        for (com.sun.javadoc.ClassDoc superclass = superclass(); superclass != null && !superclass.qualifiedTypeName().equals("java.lang.Object"); superclass = superclass.superclass()) {
    ...
    public IntroducedSuperDoc[] introducers() {
        ...
        return (IntroducedSuperDoc[]) introducers.toArray(new IntroducedSuperDoc[introducers.size()]);
    }
    ...
    public int modifierSpecifier() {
        return super.modifierSpecifier() | (isInterface() ? Modifier.INTERFACE : 0);
    }
