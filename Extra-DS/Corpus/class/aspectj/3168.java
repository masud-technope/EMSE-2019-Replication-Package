...
public class AjcSpecTest extends TestCase {
    ...
    public static void sameAjcSuiteSpec(AjcTest.Suite.Spec lhsSpec, AjcTest.Suite.Spec rhsSpec, Assert a) {
    ...
    public static void sameAjcTestSpec(AjcTest.Spec lhsTest, AjcTest.Spec rhsTest, Assert a) {
    ...
    public static void sameAbstractRunSpec(AbstractRunSpec lhs, AbstractRunSpec rhs, Assert a) {
    ...
    public static void sameDirChangesSpec(DirChanges.Spec lhs, DirChanges.Spec rhs, Assert a) {
        ...
        // XXX normalize?
        assertEquals(lhs.expDir, rhs.expDir);
