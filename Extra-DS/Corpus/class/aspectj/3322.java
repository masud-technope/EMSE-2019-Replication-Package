...
public class TagImpl implements Tag {
     ...
     */
    public  TagImpl(Doc doc, String name, String text, Locale locale, ErrPrinter err) {
        this.doc = doc;
        this.name = name;
        this.text = text;
        this.locale = locale;
     ...
     * @see Util#start(char)
     */
    protected static final boolean start(char c) {
        return Util.start(c);
    }
     ...
     * @see Util#ident(char)
     */
    protected static final boolean ident(char c) {
        return Util.ident(c);
    }
     ...
     * @see Util#space(char)
     */
    protected static final boolean space(char c) {
        return Util.space(c);
    }
     ...
     * @see Util#split(char)
     */
    protected static final String[] split(String s) {
        return Util.split(s);
    }
